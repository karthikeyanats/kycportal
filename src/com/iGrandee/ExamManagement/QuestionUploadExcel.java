...
public class QuestionUploadExcel
{

	static Logger log = Logger.getLogger(QuestionUploadExcel.class);

 public QuestionUploadExcel(HttpServletRequest request)
 {
 ...
 {
	 	log.info("invoking startProcess from com.iGrandee.ExamManagement.QuestionUploadExcel");
     ...
     try
     {
         ...
         String userid				= (String)session.getValue("userid");
       	 storagepath  				+= instituteid+"/"+userid+"/ExcelQuestions/";
         ...
         while(iter.hasNext()) 
         {
             ...
             } else
             {
                 ...
                 if(!fileName.equals(""))
                 {
                     ...
                     temppath = "/"+instituteid+"/"+userid+"/ExcelQuestions/doc_" + current_date_time + uploadcount + "." + FileExt;
 ...
 {
	 	log.info("invoking getParameter from com.iGrandee.Assignment.AssignmentUpload");
 ...
 {
	 	log.info("invoking getParameterValues from com.iGrandee.Assignment.AssignmentUpload");
 ...
 {
	 	log.info("invoking getFileNames from com.iGrandee.Assignment.AssignmentUpload");
