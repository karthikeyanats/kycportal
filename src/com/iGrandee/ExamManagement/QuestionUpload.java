...
public class QuestionUpload
{
	...
	static Logger log = Logger.getLogger(QuestionUpload.class);

 public QuestionUpload(HttpServletRequest request)
 {
 ...
 {
	 	log.info("invoking startProcess from com.iGrandee.ExamManagement.QuestionUpload");
     ...
     try
     {
         ...
         String userid				= (String)session.getValue("userid");
       	 storagepath  				+= instituteid+"/"+userid+"/Questions/";
         ...
         while(iter.hasNext()) 
         {
             ...
             } else
             {
                 ...
                 if(!fileName.equals(""))
                 {
                     ...
                     temppath = "/"+instituteid+"/"+userid+"/Questions/doc_" + current_date_time + uploadcount + "." + FileExt;
