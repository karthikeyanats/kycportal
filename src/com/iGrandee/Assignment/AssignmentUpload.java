...
public class AssignmentUpload
{
	...
	static Logger log = Logger.getLogger(AssignmentUpload.class);

 public AssignmentUpload(HttpServletRequest request)
 {
 ...
 {
	 	log.info("invoking startProcess from com.iGrandee.Assignment.AssignmentUpload");
     ...
     try
     {
         ...
         String userid				= (String)session.getValue("userid");
       	 storagepath  				+= instituteid+"/"+userid+"/Assignment";
         ...
         while(iter.hasNext()) 
         {
             ...
             } else
             {
                 ...
                 if(!fileName.equals(""))
                 {
                     ...
                     temppath = "/"+instituteid+"/"+userid+"/Assignment/doc_" + current_date_time + uploadcount + "." + FileExt;
