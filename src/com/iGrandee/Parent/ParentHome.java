 ...
 */
 public ArrayList CircularViewListForStudentPage(String circularid)
 {
     ...
     try
     {
    	 ...
    	 select_query="select a.createdby,case when d.middlename='-' or d.middlename='' or d.middlename  is null then concat(d.prefix,d.firstname,' ',d.lastname) else concat(d.prefix,d.firstname,' ',d.middlename,' ',d.lastname) end as uname ,a.circularid,a.subject,a.details,a.attachments,date_format(a.dateofcreation,'%d-%b-%Y') as dateofcreation,date_format(a.validityfrom,'%d-%b-%Y') as sdate,date_format(a.validityto,'%d-%b-%Y') as edate   from circular a join circulardetails b on b.circulardetailsstatus='A' and a.circularstatus='A' and a.circularid='"+circularid+"' and b.circularid=a.circularid join login c on c.userid=a.createdby join personmaster d on c.personid=d.personid";
