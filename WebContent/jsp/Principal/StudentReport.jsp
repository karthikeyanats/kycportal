...
<%@ include file="../include/header.jsp" %>
    ...
    <h2> <%=bundle.getString("hmlabel.studentlist.rootpath")%></h2>
<%@ page language="java"
...
%>
		...
		<table width='80%' id=rounded-corner align='center' border='0' >
			...
			<tr>
				...
				<th scope="col" class="rounded" width="100%" colspan=5><%=bundle.getString("hmlabel.studentlist.studentlistview")%></th>
		...
		<tbody ><tr>
		<td></td>
				<td width='20%' class='tablebold'><%=bundle.getString("hmlabel.studentlist.academicyear")%></td>
				...
				<td width='5%' class='tablebold'><%=bundle.getString("hmlabel.studentlist.board")%></td>
				<td width='1%' class='tablebold'>:</td>
				<td class='tablelight' width='40%'>
			...
			<tr>
				...
				<td width='20%' class='tablebold' ><%=bundle.getString("hmlabel.studentlist.standard")%></td>
				<td width='1%' class='tablebold'>:</td>
				<td class='tablelight'>
				...
				<td  class='tablebold'><%=bundle.getString("hmlabel.studentlist.section")%></td>
				<td width='1%' class='tablebold'>:</td>
				<td class='tablelight'>
		...
		<a href="#" class="bt_blue" onClick='loadstudent()'><span class="bt_blue_lft"></span><strong><%=bundle.getString("hmbutton.studentlist.loadstudent")%></strong><span class="bt_blue_r"></span></a>
		</form>		
