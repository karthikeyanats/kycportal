...
<%@ include file="../include/header.jsp" %>
    ...
    <h2> <%=bundle.getString("hmlabel.studentlistview.rootpath")%></h2>
<%@ page language="java"
...
<form name="StudentReport_Form" action="" method="post">
		...
		<table>		
		<tr>
			<td width='20%' valign=top class='tablebold'><%=bundle.getString("hmlabel.studentlistview.archivdetails")%></td>
			<td width='1%' valign=top class='tablebold'>:</td>
			<td valign=top class='tablelight' width='79%'>
				<h2><%=bundle.getString("hmlabel.studentlistview.archivinfo")%></h2>
			</td>
		</tr>
		</table>
		<%		
...
%>
		...
		<table width='80%' id=rounded-corner align='center' border='0' >
		 <thead>
		    	<tr>
		            ...
		            <th scope="col" class="rounded" colspan=6 width="100%"><%=bundle.getString("hmlabel.studentlistview.selectinfo")%></th>
			...
			<tr>
			<td></td>
				<td width='20%' class='tablebold'><%=bundle.getString("hmlabel.studentlistview.academicyear")%></td>
				<td width='1%' class='tablebold'>:</td>
				<td class='tablelight' width='40%'>
				<%=sessionname%>
				</td>
				<td width='5%' class='tablebold'><%=bundle.getString("hmlabel.studentlistview.board")%></td>
				<td width='1%' class='tablebold'>:</td>
				<td class='tablelight' width='40%'>
					<%=boardname%>
				</td>
			...
			<tr>
			<td></td>
				<td width='20%' class='tablebold' ><%=bundle.getString("hmlabel.studentlistview.standard")%></td>
				<td width='1%' class='tablebold'>:</td>
				<td class='tablelight'>
					<%=standardschedulename%>
				</td>
				<td  class='tablebold'><%=bundle.getString("hmlabel.studentlistview.section")%></td>
				<td width='1%' class='tablebold'>:</td>
				<td class='tablelight'>
					<%=sectionschedulename%>
				</td>
		...
		<br>
					<table id="rounded-corner" border=0  width="100%">
					    <thead>
					    	<tr>
					        	<th scope="col" class="rounded-company" width="10%"><%=bundle.getString("hmlabel.studentlistview.slno")%></th>
					            <th scope="col" class="rounded" width="30%"><%=bundle.getString("hmlabel.studentlistview.studentname")%></th>
					            <th scope="col" class="rounded"	width="20%"><%=bundle.getString("hmlabel.studentlistview.rollno")%></th>
					            <th scope="col" class="rounded"	width="20%"><%=bundle.getString("hmlabel.studentlistview.mobileno")%></th>
					            <th scope="col" class="rounded-q4" width="20%"><%=bundle.getString("hmlabel.studentlistview.email")%></th>
					        </tr>
					    </thead>
						<tfoot>
						   	<tr>
		...
		<br>
		<%}%>		
		<a href="#" class="bt_blue" onClick='backfun()'><span class="bt_blue_lft"></span><strong><%=bundle.getString("hmbutton.studentlistview.back")%></strong><span class="bt_blue_r"></span></a>
