...
<script type="text/javascript">
	...
	function ViewsubjectPieChart()
	{
			...
			else
		{
			...
			document.ExammarkEntryForm.reg_coursepubid_hidden.value = document.ExammarkEntryForm.course.options[document.ExammarkEntryForm.course.options.selectedIndex].value;
			document.ExammarkEntryForm.action="ChartView.jsp?chartpage=subject";
		//document.ExammarkEntryForm.action="SubjectResultPieChartForSubject.jsp";
			document.ExammarkEntryForm.submit();
		}
	}
	
	function ViewsubjectChart()
	{
		document.ExammarkEntryForm.reg_boardid.value  = document.ExammarkEntryForm.boardname.options[document.ExammarkEntryForm.boardname.options.selectedIndex].value;
		document.ExammarkEntryForm.reg_coursepubid.value  = document.ExammarkEntryForm.course.options[document.ExammarkEntryForm.course.options.selectedIndex].value;
		document.ExammarkEntryForm.reg_sectionpubid.value  = document.ExammarkEntryForm.section.options[document.ExammarkEntryForm.section.options.selectedIndex].value;
			...
			else
		{
			...
			document.ExammarkEntryForm.reg_coursepubid_hidden.value = document.ExammarkEntryForm.course.options[document.ExammarkEntryForm.course.options.selectedIndex].value;
			//document.ExammarkEntryForm.action="SubjectResultPieChartView.jsp";
			document.ExammarkEntryForm.action="SubjectResultPieChartForSubject.jsp";
	...
	function ViewStudentChart()
	{
			...
			else
		{
			...
			document.ExammarkEntryForm.reg_coursepubid_hidden.value = document.ExammarkEntryForm.course.options[document.ExammarkEntryForm.course.options.selectedIndex].value;
			document.ExammarkEntryForm.action="ChartView.jsp?chartpage=student";
			document.ExammarkEntryForm.submit();
		}
	}
</script>
...
<%@ include file="../include/header.jsp" %>
    ...
    <h2><%=bundle.getString("label.exampass.chartrootpath")%></h2>


	<table id="rounded-corner" border=0 width="100%">
    	<thead>
    		<tr>
            	<th scope="col" class="rounded-company" width="100%"><%=bundle.getString("label.exampass.chartheader")%></th>
		...
		%>
			...
			<tr>
				<td class=tablebold><%=bundle.getString("label.exampass.academic")%></td><td width=1px class=tablebold>:</td><td>
					<%=session.getValue("sessionname") %>
				</td>
				<td class=tablebold><%=bundle.getString("label.exampass.board")%> </td>
			...
			<tr>
				<td class=tablebold><%=bundle.getString("label.exampass.examname")%> </td>
				<td width=1px class=tablebold>:</td><td>
				...
				<td class=tablebold><%=bundle.getString("label.exampass.standard")%> </td>
			...
			<tr>
				<td class=tablebold><%=bundle.getString("label.exampass.section")%> </td>
				<td width=1px class=tablebold>:</td><td><select name=section class=tablelight onchange=loadSubject() style='width:150px'>
				...
				<a href="#" class="bt_blue" onclick="ViewsubjectChart()"><span class="bt_blue_lft"></span><strong><%=bundle.getString("button.exampass.viewpie")%></strong><span class="bt_blue_r"></span></a>
				<a href="#" class="bt_blue" onclick="ViewsubjectPieChart()"><span class="bt_blue_lft"></span><strong><%=bundle.getString("button.exampass.viewsubj")%></strong><span class="bt_blue_r"></span></a>
				<a href="#" class="bt_blue" onclick="ViewStudentChart()"><span class="bt_blue_lft"></span><strong><%=bundle.getString("button.exampass.viewexam")%></strong><span class="bt_blue_r"></span></a>
