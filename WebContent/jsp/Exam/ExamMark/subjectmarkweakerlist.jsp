...
<title><%=bundle.getString("label.product.name")%> - <%=bundle.getString("label.exam.weakerlisttitle")%> | Powered by i-Grandee</title>
...
<%@ include file="../../include/header.jsp" %>
    ...
    <h2><%=bundle.getString("label.exam.weakerlistrootpath")%> </h2>
		    ...
		    <table id="rounded-corner" border=0 summary="Department List" width="100%">
		    	...
		    	<thead>
		    		<tr>
		            	<th scope="col" class="rounded-company" width="100%"><%=bundle.getString("label.exam.SubjectwiseWeakersList")%></th>
...
<%
		...
		if(request.getParameter("boardname") != null  && request.getParameter("examname") != null && request.getParameter("course") != null && request.getParameter("subject") != null){	
			studentList			= examQuery.subjectTopperWeekerList(standardid,reg_examid,"asc",students,subjectid);
...
%>
		...
		<table width='100%' align='center' id="rounded-corner1" border='0' cellpadding='5' cellspacing='0' >
			<tr >
				...
				<!--  	<select name=sessionname class=tablelight onchange='changeSession()' validate='Academic Year'>
				...
				<td width=1px class=tablebold>:</td><td>
					<select name=boardname class=tablelight onchange=loadExam() validate='Board Name'>
			...
			<tr>
				...
				<td width=1px class=tablebold>:</td>
				<td><select name=course class=tablelight onchange='changeStandard()' validate='Standard Name' >
			...
			<tr >
				...
				<td width=1px class=tablebold>:</td><td><select name=subject class=tablelight validate='Subject Name'>
