...
<title>Know Your Child - Weaker List | Powered by i-Grandee</title>
...
function goBack()
{
	document.Topper_Form.action="Multisubjectweakerlist.jsp";
...
%>
		...
		<table width='100%' align='center' id="rounded-corner1" border='0' cellpadding='5' cellspacing='0' >
			<tr >
				...
				<td class=tablebold width='10%'>Board </td>
				<td>
					<%=req_boardname%>
				</td>
			</tr>
			<tr>
				<td class=tablebold>Exam </td>
				<td>
					<%=req_examname%>
				</td>
	...
	<br>
		...
		<table id="rounded-corner1" border=2  cellspacing=0 cellpadding=5  width="100%">
            ...
            <th scope="col" class="rounded"  colspan=<%=colspancount %>>Subject Wise Weaker</th>               
            <tr  class=tableheading>
		    ...
		    <tbody>
				    	...
				    	{  out.print("<td>");	
				    		...
				    		{            	  
								...
								rollno="<font size='1px' class='tablelight' >Not Generated</font>";
								...
								{
									marktaken="<font size='1px' class='tablelight'  >Not Entered</font>";
								}
								else
								{
