...
<title>Know Your Child - <%=bundle.getString("label.subjectwisetopperweaker.entrytitle") %> | Powered by i-Grandee</title>
...
<script type="text/javascript">
	...
	function publishStandard()
	{
		...
		if(check_ForParticularElements(document.Topper_Form.sessionname,"select",document.Topper_Form.boardname,"select",document.Topper_Form.examname,"select",document.Topper_Form.course,"select",document.Topper_Form.subject,"select",document.Topper_Form.optionsselect,"select"))
		{
		
		var optionsselect=document.Topper_Form.optionsselect.options[document.Topper_Form.optionsselect.options.selectedIndex].value;
		...
		if(optionsselect=="01")
		{
			document.Topper_Form.optionsselect_temp.value="desc";
		}
		else if(optionsselect=="02")
		{
			document.Topper_Form.optionsselect_temp.value="asc";
		}
		document.Topper_Form.action="MultisubjectTopperlist.jsp";
	    document.Topper_Form.submit();
...
<%@ include file="../../include/header.jsp" %>
    ...
    <h2><%=bundle.getString("label.subjectwisetopperweaker.entryrootpath") %></h2>
		    ...
		    <table id="rounded-corner" border=0  width="100%">
		    	<thead>
		    		<tr>
		            	...
		            	<th scope="col" class="rounded" width="100%"><%=bundle.getString("label.subjectwisetopperweaker.SubjectwiseTopperWeakerList") %></th>
...
%>
	...
	<input type="hidden" name="optionsselect_temp" value="">  
	
	
		
		<table width='100%' align='center' id="rounded-corner1" border='0' cellpadding='5' cellspacing='0' >
			<tr >
				<td class=tablebold width='15%'><%=bundle.getString("label.subjectwisetopperweaker.AcademicYear") %><font color="red"> *</font></td>
				<td>
				...
				<td class=tablebold width='10%'><%=bundle.getString("label.subjectwisetopperweaker.Board") %> <font color="red">*</font></td>
				<td>
			...
			<tr>
				<td class=tablebold><%=bundle.getString("label.subjectwisetopperweaker.Exam") %> <font color="red">*</font></td>
				<td>
				...
				<td class=tablebold><%=bundle.getString("label.subjectwisetopperweaker.Standard") %> <font color="red">*</font></td>
			...
			<tr >
				<td class=tablebold><%=bundle.getString("label.subjectwisetopperweaker.Subject") %> <font color="red">*</font></td>
				...
				<td class=tablebold width="20%"><%=bundle.getString("label.subjectwisetopperweaker.SelectCategory") %><font color="red"> *</font></td>
				<td><select name=optionsselect validate="Toper or Weaker " class=tablelight >
					<option value="00">-Select Subject-</option>
					<option value="01">Topper</option>
					<option value="02">Weaker</option>
					</select>
				</td>
				</tr>
				<tr>
				<td class=tablebold><%=bundle.getString("label.subjectwisetopperweaker.Top") %></td>
				<td>
					...
					<a class='tablebold'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=bundle.getString("label.subjectwisetopperweaker.Students") %></a>
				</td>
	...
	<br>
     ...
     <a href="#" class="bt_green" onclick='publishStandard()'><span class="bt_green_lft"></span><strong><%=bundle.getString("button.subjectwisetopperweaker.LoadStudents")%></strong><span class="bt_green_r"></span></a>
