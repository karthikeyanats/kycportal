...
try{
	...
	rows = examAllotmentQuery.updateMarkStaff(examschid,chkBoxId,markTaken,staffRemarks,comboRemarks,createdby,ipaddress); 
	if (rows>0)
		op="Examination Mark Successfully Updated";
	else
		op="Examination Mark Updation Failed";
