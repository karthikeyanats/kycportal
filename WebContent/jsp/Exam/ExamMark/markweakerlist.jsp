...
<%@ include file="../../include/header.jsp" %>
    ...
    <h2><%if(usercategory.equals("HM"))
    {%><%=bundle.getString("label.exammark.rootpathweeker")%><%}else{ %>
    <%=bundle.getString("label.exammark.Rootpathwekar_admin")%><%} %></h2>
		<form name="Topper_Form" action="" method="post">
		    <table id="rounded-corner" border=0 summary="Department List" width="100%">
		    	<thead>
  				<tr>
        	 <th scope="col" class="rounded-company" width="80%"><%=bundle.getString("label.exammark.weekerslist")%></th>      
...
<%
		...
		if(request.getParameter("sessionname") != null && request.getParameter("boardname") != null  && request.getParameter("examname") != null && request.getParameter("course") != null){
			studentList			= examQuery.standardTopperWeekerList(standardid,reg_examid,"asc",students);  
