...
try{	
		...
		//System.out.println("checkstandard>>>"+checkstandard.length);
		...
		result					= schedule.UpdateScheduleExams(checkstandard,examallotmentid,allotedby,instituteid,examdate,starttime,endtime,examtype); 
		  
		if(result >0)
			op	= "Scheduled Exam Time Updated Successfully";
		else
			op	= "Updation of Scheduled Exam Failed";
