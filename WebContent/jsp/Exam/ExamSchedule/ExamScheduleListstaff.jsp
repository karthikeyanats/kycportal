...
<table id="rounded-corner" border=0 summary="Examschedule List" width="100%" align="center">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded-q4" width="10%"><%=bundle.getString("label.exam.Duration") %></th>
    ...
    <tfoot>
     ...
     try
     {
    		...
    		LoadExamScheduleList=examnameEntry.LoadScheduledExamList(examnameid,userid);
    	 ...
    	 if(LoadExamScheduleList!=null && LoadExamScheduleList.size()>0)
			{
    		 ...
    		 for (int i = 0, j = 1; i < LoadExamScheduleList.size(); i++) {
            	...
            	<%if(!temp_standardid.equals(standardid))
				{
					out.println("<tr><td colspan=6 class=tablebold>"+standardname+"</td></tr>");
					temp_standardid = standardid;
            ...
            <td><%=duration %></td>                       
				...
				<%
    	 		...
    	 		out.println("<tr align='center' class='tablebold'><td colspan='10'><font color='red'>Data Not Found</font></td></tr>");
