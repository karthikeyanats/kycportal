...
<script type="text/javascript">
	...
	document.StudentReport_Form.action="./sectionwisepasslistview.jsp"
...
<%@ include file="../../include/header.jsp" %>
    ...
    <h2> <%=bundle.getString("label.exampass.secrootpath")%></h2>
<%@ page language="java"
...
%>
		...
		<table width='80%' id=rounded-corner align='center' border='0' >
			<thead>
			<tr>
				<th scope="col" class="rounded-company" width="100%" colspan=5><%=bundle.getString("label.exampass.secwisepass")%></th>
