...
{
	document.f1.action = "./adminSubmitPassword.jsp";
	document.f1.submit();
}
...
<h2>General / Change Password / Change Password Updation</h2>  
...
<table border=0 cellpadding=5 cellspacing=0 width="100%" align=center>
	<tr><td class=tablebold>Old Password</td><td><input type=password class=tablelight name=oldpassword maxlength=25> <A class=tabledivision><font color=red>*</font> 25 characters only</a></td></tr>
	<tr><td class=tablebold>New Password</td><td><input type=password class=tablelight name=newpassword maxlength=25> <A class=tabledivision><font color=red>*</font> 25 characters only</a></td></tr>
	<tr><td class=tablebold>Confirm Password</td><td><input type=password class=tablelight name=confirmpassword maxlength=25> <A class=tabledivision><font color=red>*</font> 25 characters only</a></td></tr>
<tr><td class=tablebold colspan=2><a href="#na2" name="na2" class="bt_blue" onclick="backfun()"><span class="bt_blue_lft"></span><strong>Back</strong><span class="bt_blue_r"></span></a><a href="#na2" name="na2" class="bt_green" onclick="Submitfun()"><span class="bt_green_lft"></span><strong>Submit</strong><span class="bt_green_r"></span></a></td></tr>
</table>
<%}
else
{%>
