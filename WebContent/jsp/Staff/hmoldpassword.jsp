...
function backfun()
{
	...
	document.f1.action = "./hmchangepasswd.jsp";
	document.f1.submit();
...
if(confirm("Do you want to Change the Password...?"))
{
	document.f1.action = "./hmCheckPassword.jsp";
	document.f1.submit();
}
...
<h2><%=bundle.getString("hmlabel.changepassword.rootpath1") %></h2>
