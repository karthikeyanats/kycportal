...
<h2><%=bundle.getString("label.tracking.changepasswordrootpath_2") %></h2>  
...
<table border=0 cellpadding=5 cellspacing=0 width="100%" align=center>
	<tr><td class=tablebold><%=bundle.getString("label.tracking.OldPassword") %></td><td>&nbsp;<b>:</b>&nbsp;<input type=password class=tablelight name=oldpassword maxlength=25> <A class=tabledivision><font color=red>*</font> <%=bundle.getString("label.tracking.25charactersonly") %></a></td></tr>
	<tr><td class=tablebold><%=bundle.getString("label.tracking.NewPassword") %></td><td>&nbsp;<b>:</b>&nbsp;<input type=password class=tablelight name=newpassword maxlength=25> <A class=tabledivision><font color=red>*</font> <%=bundle.getString("label.tracking.25charactersonly") %></a></td></tr>
	<tr><td class=tablebold><%=bundle.getString("label.tracking.ConfirmPassword") %></td><td>&nbsp;<b>:</b>&nbsp;<input type=password class=tablelight name=confirmpassword maxlength=25> <A class=tabledivision><font color=red>*</font> <%=bundle.getString("label.tracking.25charactersonly") %></a></td></tr>
<tr><td class=tablebold colspan=2><a href="#na2" name="na2" class="bt_blue" onclick="backfun()"><span class="bt_blue_lft"></span><strong><%=bundle.getString("button.tracking.Back") %></strong><span class="bt_blue_r"></span></a><a href="#na2" name="na2" class="bt_green" onclick="Submitfun()"><span class="bt_green_lft"></span><strong><%=bundle.getString("button.tracking.Submit") %></strong><span class="bt_green_r"></span></a></td></tr>
</table>
<%}
else
{%>
	...
	<tr><td class=tablebold><center><div class="error_box" style="width:50">
					        <center><%=bundle.getString("label.tracking.EnteredWrongPassword") %></center></div></center></td></tr>
<tr><td class=tablebold ><a href="#na2" name="na2" class="bt_blue" onclick="backfun()"><span class="bt_blue_lft"></span><strong><%=bundle.getString("button.tracking.Back") %></strong><span class="bt_blue_r"></span></a></td></tr>
</table>
<%}
}
					catch(Exception e)
