...
<h2>General / Change Password / Change Password View</h2>
...
<%@page import="com.iGrandee.Prinicipal.PrinicipalQuery"%>
						...
						<% 
							...
							for (int i = 0; i < profiledetails.size(); i++) {
								...
								out
										.println("<td class=tablebold>Name</td><td class=tablebold>:</td><td>"	+ username + "</td>");
								out
								...
								out
										.println("<td class=tablebold>Role</td><td class=tablebold>:</td><td>" + session.getValue("userrolename")
												+ "</td>");
								...
								out.println("<td class=tablebold>Mobile No</td><td class=tablebold>:</td><td>" + mobilenumber + "</td>");
								...
								out.println("<td class=tablebold>Email</td><td class=tablebold>:</td><td>" + emailid + "</td>");

								out.println("</tr>");
								out.println("<tr>");

								out.println("<td class=tablebold>UserName</td><td class=tablebold>:</td><td colspan=2>" + usernames + "</td>");

								out.println("</tr>");
								out.println("<tr>");

								out.println("<td class=tablebold>Password</td><td class=tablebold>:</td><td colspan=2>************&nbsp;&nbsp;&nbsp;<a href='#' onclick='changepasswd()'><font color=red>(&nbsp;Change Password&nbsp;)</font></a></td>");
