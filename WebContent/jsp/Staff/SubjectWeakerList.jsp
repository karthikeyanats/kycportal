...
<title>Know Your Child - <%=bundle.getString("label.exam.weakerlisttitle") %> | Powered by i-Grandee</title>
		    ...
		    <table id="rounded-corner" border=0 summary="Department List" width="100%">
		    	<thead>
		    		<tr>
		            	...
		            	<th scope="col" class="rounded-company" width="80%"><%=bundle.getString("label.exam.SubjectwiseWeakersList") %></th>
