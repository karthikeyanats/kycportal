...
function backfun()
{
document.Student_Form.action="./CommunitySecView.jsp";
document.Student_Form.submit();
}
...
<%
		...
		if(((session.getValue("userrolename")+"").toLowerCase()).startsWith("admin"))
		{
			   ...
			   rootlabel=bundle.getString("label.reports.reportscommunitysectionwise");
		...
		if(operation.equalsIgnoreCase("community")){
			operationquery = "pm.community="+request.getParameter("communityid")+" and ";
...
%>
    ...
    <h2>Reports / Session wise Report / Community wise Student List / Section Wise / Student List</h2>
...
<form name="Student_Form" action="" method="post">
						...
						<input type="hidden" name="condition" value="communitysecview">
