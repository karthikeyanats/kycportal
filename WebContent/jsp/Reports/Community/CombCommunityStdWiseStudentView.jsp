...
function backfun()
{
document.Student_Form.action="./CombCommunityStdView.jsp";
document.Student_Form.submit();
}
...
<%
		...
		if(operation.equalsIgnoreCase("both")){
			...
			operationlabel=operationlabel+" / Ex-Service Man";
		}
		...
		if(!standardscheduleid.equals("null")  && !operation.equals("null"))
		{
...
<form name="Student_Form" action="" method="post">
						...
						<input type="hidden" name="condition" value="combcommunityview">
