...
function backfun()
{
document.Student_Form.action="./ReligionSecView.jsp";
document.Student_Form.submit();
}
...
<%
		...
		if(((session.getValue("userrolename")+"").toLowerCase()).startsWith("admin"))
		{
			   ...
			   rootlabel=bundle.getString("label.reports.reportsreligionsectionwise");
...
<form name="Student_Form" action="" method="post">
						...
						<input type="hidden" name="condition" value="religionsecview">
