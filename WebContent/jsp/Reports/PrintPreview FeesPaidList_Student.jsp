...
<title>Know Your Child - Fees Paid List | Powered by i-Grandee</title>
...
<%
       ...
       %>
		...
		<tr><td width="35%" valign=top align=center>Fees Paid Student List
		</td></tr>
		<tr><td valign=top><br>
					...
					<table id="rounded-corner" border=1 summary="Department List" width="100%" cellspacing=0 cellpadding=5 bordercolor=grey>   
					    <thead>
					    	<tr>
            					...
            					<th  align=left width="27%">Student Name</th>
            					<th  align=left width="15%">Section</th>
	...
	if(pendingFeesList.size()!=0)
	{
		for(int i=0;i<pendingFeesList.size();i++)
		{
			...
			if(feeStatus.equals("Paid") || feeStatus.equals("Excess")){
				...
				out.print("<tr class='tablelight' ><td>"+(count)+"</td><td>"+applicantName+"</td><td>"+sectionName+"</td><td>"+rollNo+"</td><td>"+formattedFeesPaidCurrency+"</td></tr>");
			}
		}
	}
	else
