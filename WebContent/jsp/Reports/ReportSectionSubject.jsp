...
<%@ include file="../include/header.jsp" %>
    ...
    <h2><%=bundle.getString("label.reports.sectionwisesubjectreport")%></h2>
...
<%
	...
	ArrayList examList		= reports.sectionSubjectPassDetails(sectionid,standardid,examnameid);
		...
		<%
			...
			if(examList != null && examList.size()>0){
				for(int y=0;y<examList.size();y++){
					...
					staffList		= reports.sectionSubjectStaffDetails(sectionid,subjectid);
					...
					out.print("</table></td><td>"+percent+"</td><td><a href='#cls' subjectscheduleid='"+subjectid+"' subjectname='"+hashmap.get("subjectname")+"' facultyname='"+staffname+"' status='Passed' onclick='callSection(this)'>"+bundle.getString("label.schedule.passedlist")+"</a>&nbsp;|&nbsp;<a href='#cls' subjectscheduleid='"+subjectid+"' status='Failed' subjectname='"+hashmap.get("subjectname")+"' facultyname='"+staffname+"' onclick='callSection(this)'>"+bundle.getString("label.schedule.failedlist")+"</a></td></tr>");
				}
			}
			else{
