...
<%@ include file="../include/header.jsp" %>
    ...
    <h2>Reports / Result Analysis / Exam List / Sectionwise Subject <%=status %> Student Report</h2>
	...
	<%
		...
		if(status != null && status.equals("Passed"))
			examList				= reports.passedSubjectStudentList(examnameid,standardid,subjectid);
		else
			examList				= reports.failedSubjectStudentList(examnameid,standardid,subjectid);
		
		//out.println(examnameid+"_"+standardid+"_"+subjectid);
