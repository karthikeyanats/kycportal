...
<%@ include file="../include/header.jsp" %>
    ...
    <h2><%=bundle1.getString("label.feespending.rootpathforreport")%></h2>
...
<table width="100%">
<tr>
	<td class=tablebold width="25%"><%=bundle1.getString("label.feespending.AcademicYear")%></td>
	<td width="1%" class=tablebold>:</td>
	<td class=tablelight ><%=yearofsession %></td>
	<td class=tablebold><%=bundle1.getString("label.feespending.Board")%> </td>
	<td width="1%" class=tablebold>:</td>
...
%>
		...
		<a href="#" class="bt_green" onclick='printfun()'><span class="bt_green_lft"></span><strong><%=bundle1.getString("button.feespending.Print")%></strong><span class="bt_green_r"></span></a>
		<%
