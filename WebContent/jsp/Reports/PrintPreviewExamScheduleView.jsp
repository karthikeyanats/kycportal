...
<form name="Schedule_Form" action="" method="post">
		...
		<tr><td width="35%" valign=top align=left>Exam Allotment List
		</td></tr>
		<tr><td valign=top><br>
				 		...
				 		<table border=1 summary="Department List" width="100%" cellspacing=0 cellpadding=5 bordercolor=grey>   
								    <thead>
								    	<tr  class='tablebold'>
								            ...
								            <th  align=left  		width="30%">Subject Name</th>
								            <th  align=left  		width="17%">Exam Date</th>
								            <th  align=left 		width="10%">Start Time</th>
								            <th  align=left 		width="10%">End Time</th>
								            <th align=left 	width="10%">Duration</th>
								        </tr>
								    </thead>
								    <tbody>
				 		<%
							...
							HashMap subjectListMap1=(HashMap)subjectList.get(i1);
		 					...
		 					String examnameid1      = (String)subjectListMap1.get("examnameid");
				 				if(examnameid.equals(examnameid1))
							 	{
									...
									{
							 			out.println("<tr>");
								 		out.println("<td colspan=6 class='tableheading'>"+standardname+"</td>");
								 		out.println("</tr>");
									...
									//else
							 		...
							 		out.println("<td>"+examtimein+"</td>");
							 		out.println("<td>"+examtimeout+"</td>");
