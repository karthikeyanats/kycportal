...
function goBack()
{
		document.ApplicantSearch.action="ReportIndex.jsp";
...
<input type=hidden name=req_standardpubid value="<%=request.getParameter("req_standardpubid_hidden") %>" />
<!-- String req_standardpubid 		= request.getParameter("reg_coursepubid_hidden");
		out.println("req_standardpubid===>>>"+req_standardpubid);
 -->
...
<div style="float:left" > <!--This is the first division of left-->
  <div id="firstpane"  class="menu_list"> <!--Code for menu starts here-->
		...
		<%-- <p class="menu_head" align="left"><a href="javascript:void(0)"><%=bundle.getString("label.reports.fees")%></a></p>
