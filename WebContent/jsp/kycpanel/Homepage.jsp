	...
	<tr>
		<td width="60%" valign="top" >
			<table border=0 cellpadding=0 cellspacing=0 width="100%" id="rounded-corner_home" >
				 <thead>
				<tr valign="top">
		        	<th scope="col" class="rounded-company" width="90%"><%=bundle.getString("label.adminportal.Services") %></th>
		     	...
		     	<td colspan=2>
			     	<table border=0 cellpadding=0 cellspacing=0 width="100%">
			     		<tr align=center>
			     			...
			     			<td><img src="<%=request.getContextPath()%>/jsp/kycpanel/images/Teachers Time Table.png" title="Staff Time Table" border=0></img></td><td><img src="<%=request.getContextPath()%>/jsp/kycpanel/images/applicationissue.png" title="Application Issue" border=0></img></td>
			     		
			     		</tr> 
			     		<tr align=center class=tablebold>
			     			<td><a href="<%=request.getContextPath()%>/jsp/TimeTable/ScheduleSelect.jsp">Staff TimeTable</a></td><td><a href="<%=request.getContextPath()%>/jsp/ApplicationForm/ApplicationIssue_Pre1.jsp">Application Issue</a></td>
			     		</tr>
						<%-- <tr align=center>
						<td><img src="<%=request.getContextPath()%>/jsp/kycpanel/images/Student Absent.png" title="Today Student Absentees" border=0></img></td><td><img src="<%=request.getContextPath()%>/jsp/kycpanel/images/Fees.png" title="Fees Collection" border=0></img></td></tr> --%>
						<%-- <tr align=center>
							<td><img src="<%=request.getContextPath()%>/jsp/kycpanel/images/Student Absent.png" title="Today Student Absentees" border=0></img></td>
						
						 <td><img src="<%=request.getContextPath()%>/jsp/kycpanel/images/Fees.png" title="Fees Collection" border=0></img></td> </tr> --%> 
						 
						<%-- <tr align=center class=tablebold> 
							<td><a href="<%=request.getContextPath()%>/jsp/Attendance/AdminAttendanceView.jsp" title="Today Student Absentees">Today Student Absentees</a></td><td><a href="<%=request.getContextPath()%>/jsp/Fees/FeesCollection_pre.jsp">Fees Collection</a></td></tr> --%>
							
						<tr align=center>
							<td><img src="<%=request.getContextPath()%>/jsp/kycpanel/images/Student Profile.png" title="Student Profile" border=0></img></td>
							<td><img src="<%=request.getContextPath()%>/jsp/kycpanel/images/Student Absent.png" title="Today Student Absentees" border=0></img></td>
						</tr>
											
						<tr align=center class=tablebold>
							<td><a href="<%=request.getContextPath()%>/jsp/Registration/StudentApplicationSearch.jsp">Student Profile</a></td>
							<td><a href="<%=request.getContextPath()%>/jsp/Attendance/AdminAttendanceView.jsp" title="Today Student Absentees">Today Student Absentees</a></td>
						</tr>
						
						<tr align=center>
						<td><img src="<%=request.getContextPath()%>/jsp/kycpanel/images/Sudent Attendance.png" title="Attendance Entry" border=0></img></td>
							<td><img src="<%=request.getContextPath()%>/jsp/kycpanel/images/CMS-1.jpg" title="CMS" border=0></img></td>
						</tr>
						
						<tr align=center class=tablebold>
													<td><a href="<%=request.getContextPath()%>/jsp/Attendance/AttendanceEntry.jsp">Student Attendance</a></td>
						
						<td><a href="<%=request.getContextPath()%>/jsp/ContentManagement/contenthome.jsp">Content Management System</a></td>
						
						</tr>
						<tr align=center> 
							<td><img src="<%=request.getContextPath()%>/jsp/kycpanel/images/Content View.png" title="CMS" border=0></img></td>
						<td><img src="<%=request.getContextPath()%>/jsp/kycpanel/images/Xam Mgnt.jpg" title="EMS" border=0></img></td>
						 
						</tr>
						
						<tr align=center class=tablebold>
						<td><a href="<%=request.getContextPath()%>/jsp/ContentManagement/ContentList.jsp">Content View</a></td>
						<td><a href="<%=request.getContextPath()%>/jsp/ExamManagement/ExamHome.jsp">Exam Management System</a></td>
						</tr>
						
						
						<!--						<tr align=center class=tablebold><td><a href="<%=request.getContextPath()%>/jsp/ContentManagement/contenthome.jsp">Content Management System</a></td><td><a href="<%=request.getContextPath()%>/jsp/ExamManagement/ExamHome.jsp">Exam Management System</a></td></tr>
						<tr align=center><td><img src="<%=request.getContextPath()%>/jsp/kycpanel/images/RFID Library.jpg" title="Library" border=0></img></td></tr>
						 <tr align=center class=tablebold><td><a href="<%=request.getContextPath()%>/jsp/LibraryManagement/libraryhome.jsp">Library Management System</a></td></tr>
						<tr align=center class=tablebold><td><a href="#">Library Management System</a></td></tr> -->
			     	</table>
		     	</td>
		      </tr>
			</table>
