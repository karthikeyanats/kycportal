...
<script language='javascript'>
	...
	{
var attachments=obj.getAttribute("ids"); 
	window.open("/kycportal/OpenDocument?r1=storagepath&r2="+attachments);
	} 
...
<%
	//ResourceBundle bundle = ResourceBundle
			//.getBundle("ResourceBundle.English_en");
										...
										<table border='0' align="center" width="80%" cellspacing=0
											...
											if(circulararray!=null || circulararray.size()>0)
											{
												for(int j=0;j<circulararray.size();j++)   
												{
													...
													{ 
														out.print("<tr><td colspan=4 class=tablebold>Attachments :&nbsp;&nbsp;<a href='#' ids='"+attachments+"' onclick=windopen(this)>View</a></td></tr>");
