...
<html>
<head>
<title><%=bundle.getString("label.datewisejournalsearch.entrytitle") %></title>
...
if(flage.equals("DateWise"))
{
	...
	BookList=query_object.get_All_Books_DateWise(startdate,enddate,sessionid,"Journal",instituteid);  
}
else if(flage.equals("DepartmentWise"))
{	
	department=request.getParameter("department");
	departmentname=request.getParameter("departmentname");
	BookList=query_object.get_All_Books_RackWise(department,sessionid,"Journal",instituteid);  
...
if(flage.equals("DateWise"))
{
    out.print("<h2>"+bundle.getString("label.datewisejournalsearch.entryrootpath")+"</h2>");

}
else
{
    out.print("<h2>"+bundle.getString("label.departmentwisewisejournalsearch.entryrootpath")+"</h2>");
...
<table id="rounded-corner" border=0 summary="Department List" width="100%">
   ...
   <tbody>
    		<tr valign="top">
            <td class="tablebold" valign="top" width="20%"><%=bundle.getString("label.departmentwisewisejournalsearch.departmentname") %>
            </td>
            <td class="tablebold" width="1%">:</td>
            <td width="20%" class="tablelight" >
           <%=departmentname %>
			</td>					
			 <td class="tablebold" valign="top" width="20%"><%=bundle.getString("label.departmentwisewisejournalsearch.NoofJournals") %>
            </td>
            <td class="tablebold" width="1%">:</td>
            <td width="20%" class="tablelight" >
           <%=count %>
...
%>
    ...
    <tfoot>
		...
		<% if(flage.equals("DateWise")){%>
	     <a href="DataWiseJournalSearch.jsp" class="bt_green" ><span class="bt_green_lft"></span><strong><%=bundle.getString("button.datewisebooksearch.Back") %> </strong><span class="bt_green_r"></span></a>
	<%}else
		{%>
