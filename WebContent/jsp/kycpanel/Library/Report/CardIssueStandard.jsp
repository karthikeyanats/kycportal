...
<input type=hidden name=req_sessionstatus value="">  
		...
		<%
						...
						<td></td><td align="right"><%=bundle.getString("label.cardissue.total")%>:</td><td   class=tablebold colspan=2><font size='4'><%=Totalstudent %></font></td><td  class=tablebold colspan=2><font size='4'><%=TotalIssuedcount %></font></td>
					</tr>
