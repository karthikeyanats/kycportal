...
<html>
<head>
<title><%=bundle.getString("label.bookreservecancel.entrytitle") %></title>
...
{var status=false;
	...
	if(status)
	{
		document.MainForm.action= "BookReserveCancelList.jsp";
...
<%@ include file="../../include/header.jsp" %>
    ...
    <div class="right_content">
         <h2><%=bundle.getString("label.bookreservecancel.entryrootpath")%></h2>
...
<table id="rounded-corner" border=0 width="100%">
    <thead>
    	<tr>
        	...
        	<th scope="col" class="rounded-company" width="40%"><%=bundle.getString("label.bookreservecancel.entrytableheading") %></th>
...
<br>
	 ...
	 <!-- <a href="#" class="bt_blue" onclick="searchfun()"><span class="bt_blue_lft"></span><strong><%=bundle.getString("button.bookreturn.RackwiseSearch")%></strong><span class="bt_blue_r"></span></a>-->
     <a href="#" class="bt_green" onclick="submitfun()"><span class="bt_green_lft"></span><strong><%=bundle.getString("button.bookreturn.SearchBook")%></strong><span class="bt_green_r"></span></a>
