...
<html>
<head>
<title><%=bundle.getString("label.bookexceedduedate.entrytitle") %></title>
...
{var status=false;
	...
	if(status)
	{
		document.MainForm.action= "BookExceedDuedateList.jsp";
...
<%@ include file="../../include/header.jsp" %>
    ...
    <div class="right_content">
         <h2><%=bundle.getString("label.bookexceedduedate.entryrootpath")%></h2>
...
<table id="rounded-corner" border=0 width="100%">
    <thead>
    	<tr>
        	...
        	<th scope="col" class="rounded-company" width="40%"><%=bundle.getString("label.bookexceedduedate.entrytableheading") %></th>
