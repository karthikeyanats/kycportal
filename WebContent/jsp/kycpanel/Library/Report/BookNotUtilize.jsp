...
<html>
<head>
<title><%=bundle.getString("label.booknotutilize.entrytitle") %></title>
...
BookList_book=query_object.get_NotUtilize_Books(sessionid,"bookMaster",instituteid);      
...
if(flage!=null)
{
	...
	{
		BookList_journal=query_object.get_NotUtilize_Books(sessionid,"Journal",instituteid);   
...
<%@ include file="../../include/header.jsp" %>
    ...
    out.print("<h2>"+bundle.getString("label.booknotutilize.entryrootpath")+"</h2>");
...
<tr><td colspan=2 class="tablebold">Not Utilized Book List</td></tr>
</table>
...
else if(flage.equals("Journal"))
{
		%>
<table width="100%" align="center">
<tr><td colspan=2 class="tablebold">Not Utilized Journal List</td></tr>
</table>
		<table id="rounded-corner" border=0  width="100%">
    <thead>
    	<tr>
