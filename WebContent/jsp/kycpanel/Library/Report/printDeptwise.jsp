...
<table border=0 width="100%">
    		<tr valign="top">
            <td class="tablebold" valign="top" width="40%" align=right><b><%=bundle.getString("label.department.apprsrc") %></b>
            </td>
            <td class="tablebold" width="1%">:</td>
            <td width="40%" class="tablelight">
           <%=request.getParameter("req_deptname") %>
			</td>					
			</tr> 
	</tbody>			
