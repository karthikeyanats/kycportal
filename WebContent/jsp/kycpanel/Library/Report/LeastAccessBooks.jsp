...
<html>
<head>
<title><%=bundle.getString("label.leastaccessbook.entrytitle") %></title>
...
<%@ include file="../../include/header.jsp" %>
    ...
    out.print("<h2>"+bundle.getString("label.leastaccessbook.entryrootpath")+"</h2>");
...
<tr><td class="tablebold">Least Access Book List</td>
        	...
        	<td class="rounded-foot-right">&nbsp;</td>
				...
				try
				{
			     if(BookList_book!=null && BookList_book.size()>0)
			     {
			    		 ...
			    		 //out.print("BookList_book.size()-->"+BookList_book.size());
			    	 			    	 
			    	int slno = 1;	 
			    	//for(int i=0,j=1;i<BookList_book.size();i++,j++)
			    	 for (int i=BookList_book.size()-1; i >= 0; i--)	 
			    	 {
...
<tr><td class="tablebold">Least Access Journal List</td>
<td align=right class="tablebold">
					Select Bottom
					<select name=noofbooks class=tablelight onchange=changeNumberBook(this)>
					<%
        	...
        	<td class="rounded-foot-right">&nbsp;</td>
				...
				try
				{
			     if(BookList_journal!=null && BookList_journal.size()>0)
			     {
			    	 ...
			    	 for (int i=BookList_journal.size()-1; i >= 0; i--)	 
			    	 {
