...
<div id="main_container">
	...
	{
		BookList=query_object.get_All_BooktobeReturn(startdate,enddate,sessionid,"bookMaster",instituteid); 
	}
	else if(flage_temp.equals("Journal"))
	{
		JournalList=query_object.get_All_BooktobeReturn(startdate,enddate,sessionid,"Journal",instituteid);  
...
<table border=0 width="100%">
    		<tr valign="top">
            <td class="tablebold" valign="top" width="25%">
				<%				
				if(flage_temp.equals("Book"))
				{
				   out.print("<b>Book To Be Return List</b>");
				   
				}
				else if(flage_temp.equals("Journal"))
				{
				   out.print("<b>Journal To Be Return List</b>");
    ...
    <thead>
    	<tr class=tableheading  >
            ...
            <th scope="col" class="rounded" width="10%"  rowspan=2><%=bundle.getString("label.bookreturn.AccessNo") %></th>
             ...
             <th scope="col" class="rounded" width="11%"  rowspan=2>Expected <%=bundle.getString("label.bookreturn.ReturnDate") %></th>
