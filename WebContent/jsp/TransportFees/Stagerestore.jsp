...
//	int trashlist = query_object.changetransportstage(transportstageid, "X"); 
	...
	int trashlist = query_object.changetransportstage(transportstageid,"A");

	String message="";
	if(trashlist >0)
		message = "Stage Successfully  Restored";
	else
		message = " Stage Restoring  Failed";	 

		String return_file =request.getContextPath()+"/jsp/TransportFees/Stagetrashroutewise.jsp";
