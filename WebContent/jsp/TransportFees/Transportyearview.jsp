...
{	
	...
	document.yearviewform.action = "Transporttypeview.jsp";
	document.yearviewform.submit();
}

function FeestypeViewUpdate(obj)
{	
	document.yearviewform.sessionid.value=obj.getAttribute("sessionid");
	document.yearviewform.f.value = obj.getAttribute("feestypeid");
	document.yearviewform.action = "TransporttypeviewNew.jsp";
	document.yearviewform.submit();
}
...
{	
	...
	document.yearviewform.transportfeestypename.value=obj.getAttribute("tn");
	document.yearviewform.ittid.value = obj.getAttribute("ittid");
	document.yearviewform.action = "categorytype.jsp";
   document.yearviewform.submit();
}

function Yearview(obj)
{	
	document.yearviewform.sessionid.value=obj.getAttribute("sessionid");
	document.yearviewform.transportfeestypeid.value=obj.getAttribute("transportfeestypeid");
	document.yearviewform.transportfeestypename.value=obj.getAttribute("tn");
	document.yearviewform.ittid.value = obj.getAttribute("ittid");
	document.yearviewform.action = "Yearview.jsp";
	document.yearviewform.submit();
}
...
{	
	...
	document.yearviewform.transportfeestypename.value=obj.getAttribute("tn");
	document.yearviewform.ittid.value = obj.getAttribute("ittid");
	//document.yearviewform.action = "TransportTermview.jsp";
	document.yearviewform.action = "TportTermview.jsp";
	document.yearviewform.submit();	
}
...
<%@ include file="../include/header.jsp" %>
    ...
    <h2>Transport Fees / Type Selection / List Session </h2>
...
<table id="rounded-corner" border=0 summary="Examname List" width="100%" align="center">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded" width="25%">Year of Session</th>
            <th scope="col" class="rounded" width="25%">Fees Type</th>
             <th scope="col" class="rounded" width="20%">Set Fees Type</th>
              <th scope="col" class="rounded-q4" width="20%">Set Category</th>
					...
					<tr>
						<td><%=j++ %>.</td>
							...
							<%
								...
								{	
								%>
								<a href="#" sessionid=<%=sessionid %> feestypeid=<%=transportfeestypeid %> onClick="FeestypeViewUpdate(this)" style="text-decoration:cursor;">Set Fees Type</a>
								<%
								}else
								{	
								%>
								<a href="#" sessionid=<%=sessionid %> feestypeid=<%=transportfeestypeid %>   onClick="FeestypeView(this)" style="text-decoration:cursor;">Set Fees Type</a>
								<%
								}
								%>
								</td>
								...
								<td>
									...
									{	
									%>	
									<a href="#" sessionid=<%=sessionid %> transportfeestypeid=<%=transportfeestypeid %> tn=<%=transportfeestypename %> ittid="<%=institutetransporttypeid %>" onClick="Yearview(this)" style="text-decoration:cursor;">Set Category</a>
									<%
									}else if(transportfeestypename.equalsIgnoreCase("Month Wise"))
									{	
									%>
										<a href="#" sessionid=<%=sessionid %> transportfeestypeid=<%=transportfeestypeid %> tn=<%=transportfeestypename %> ittid="<%=institutetransporttypeid %>" onClick="Monthview(this)" style="text-decoration:cursor;">Set Category</a>
									<%
									}
									else if(transportfeestypename.equalsIgnoreCase("Term Wise"))
									{	 
									%>
										<a href="#" sessionid=<%=sessionid %> transportfeestypeid=<%=transportfeestypeid %> tn=<%=transportfeestypename %> ittid="<%=institutetransporttypeid %>" onClick="Termview(this)" style="text-decoration:cursor;">Set Category</a>
									<%
									} 
