...
<%@ include file="../include/header.jsp" %>
    ...
    <div class="right_content">
                 <h2>Report / Session wise Students </h2>
    ...
    <thead>
    	<tr>
        	...
        	<th scope="col" class="rounded" width="30%">Session Name  </th>
  	        <th scope="col" class="rounded-q" width="30%">No.of.Category </th>
        	...
        	<td class="rounded-foot-right">&nbsp;</td>
				...
				{	String as=request.getContextPath();						
					...
					for(int i=0;i<ListYearsession.size();i++)
					{
						...
						out.print("<td class='tablelight' valign='top'><a href='#'   sessionid="+sessionMap.get("sessionid")+" sessionname="+sessionMap.get("sessionname")+" discountcategoryid="+sessionMap.get("discountcategoryid")+"  onclick='gostudentview(this)'>"+query_object.countcategory(sessionMap.get("sessionid")+"")+"</a></td>");
						out.print("<td class='tablelight' valign='top'>"+query_object.countdiscount(sessionMap.get("sessionid")+"")+"</td>");
