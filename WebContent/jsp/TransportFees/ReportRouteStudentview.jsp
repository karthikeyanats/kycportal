...
function backfun()
{
document.discountform.action= "Reportroutestage.jsp";
document.discountform.submit();
}
...
<%@ include file="../include/header.jsp" %>
    ...
    <div class="right_content">
           <h2>Transport Fees / Route Report / Route wise Students / Stage wise Students / Student View</h2>
