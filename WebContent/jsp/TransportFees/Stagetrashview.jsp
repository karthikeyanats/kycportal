...
function goback()
{
document.stageform.action= "StageList.jsp";
...
TransportStage=query_object.gettrashtransportstage();
...
<TABLE align="center" width="100%" height="100%" border=0 cellspacing=0
    ...
    <thead>
    	<tr>
        	...
        	<th scope="col" class="rounded" width="35%" align="right">Stage Name </th>
