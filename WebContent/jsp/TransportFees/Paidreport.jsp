...
//	document.yearviewform.action = "PaidcatList.jsp";
	document.yearviewform.action = "newreport.jsp";
...
<%@ include file="../include/header.jsp" %>
    ...
    <h2>Transport Fees / Paid Report / Session List  </h2>
...
<table id="rounded-corner" border=0 summary="Examname List" width="100%" align="center">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded-q4" width="95%">Academic Year</th>
        </tr>
    </thead>
			     ...
			     ArrayList LoadyearofsessionList = null;
					...
					<tr>
						<td><%=j++ %>.</td>
							...
							%>	
							<td>
							<a href="#" sessionname="<%=sessionname %>" institutetransporttypeid="<%=institutetransporttypeid%>" sessionid="<%=sessionid%>" onclick="goList(this)">
						...
						<%
								...
								<td>
									...
									<a href="#" sessionname="<%=sessionname %>" institutetransporttypeid="<%=institutetransporttypeid%>" sessionid="<%=sessionid%>" onclick="goList(this)"><%=sessionname %></a>
								</td>
							<%	
							}
							%>								
