...
try{
	...
	//result = query_object.changetranspotAmountDeleteStatus(transportstageamountallocationid, "X");
	result = query_object.DeletetranspotAmount(transportstageamountallocationid);
