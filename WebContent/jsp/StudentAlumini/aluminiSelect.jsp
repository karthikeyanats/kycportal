...
<title>Know Your Child - Alumni Students | Powered by i-Grandee</title>
...
<script type="text/javascript">
	...
	function listAluminiStudent()
	{
		...
		else
		{
			...
			document.ApplicantSearch.action="aluminiStudentList.jsp";
			document.ApplicantSearch.submit();
		}
...
<%@ include file="../include/header.jsp" %>
    ...
    <h2>Certificate / Alumni Students</h2>


	<table id="rounded-corner" border=0 summary="Department List" width="100%">
    	<thead>
    		<tr>
            	<th scope="col" class="rounded-company" width="80%">Alumni Students</th>
		...
		%>
			...
			<tr>
    			...
    			<a href="#" class="bt_blue" onclick="listAluminiStudent()"><span class="bt_blue_lft"></span><strong>View Alumni Students</strong><span class="bt_blue_r"></span></a>
