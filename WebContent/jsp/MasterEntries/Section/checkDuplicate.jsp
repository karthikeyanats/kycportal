...
<jsp:useBean id="validate" scope="page"
	...
	<%@ page import="java.io.*,java.util.ArrayList,java.util.HashMap"%>
			<jsp:useBean id="gradeQuery" scope="page" class="com.iGrandee.MasterEntries.Section.SectionEntry"/>
...
boolean aa=validate.checkDuplicatewithstatus("section","sectionname",fieldname,"status",instituteid);
try
...
else if(flage.equals("update"))
{
	...
	boolean checkString = false;
		...
		if((temp_str=request.getParameter("sectionname"))!=null && (temp_str1=request.getParameter("sectionid"))!=null  )
		{
