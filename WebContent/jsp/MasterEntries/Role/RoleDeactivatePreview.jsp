...
<head>
<title><%=bundle.getString("label.role.deactivatepreviewlisttitle") %></title>
...
{
	document.MainForm.action= "RoleDeactive.jsp";
document.MainForm.submit();
}
else{}
}
...
<%@ include file="../../include/header.jsp" %>
    ...
    <div class="right_content">
         <h2><%=bundle.getString("label.role.deactivatepreviewlistrootpath")%></h2>
...
<TABLE align="center" width="100%" height="100%" border=0 cellspacing=0
    ...
    <thead>
    	<tr>
        	...
        	<th scope="col" class="rounded-company" width="90%"><%=bundle.getString("label.role.deactivatepreviewtableheading")%> </th>
    ...
    <thead>
		...
		<br>
			...
			if(as.equals("0") )
			{%>
			     <a href="#" class="bt_green" onclick="goToTrash()"><span class="bt_green_lft"></span><strong><%=bundle.getString("button.role.deactivate")%></strong><span class="bt_green_r"></span></a>
			
	 <%}
	 else
	 {		 out.print("<div class='warning_box'>");

	 	out.print("<a align=center class='tablebold'>"+bundle.getString("label.role.deactivatepreviewerrormessagedetails")+" </a>");
		 out.print("</div>");
