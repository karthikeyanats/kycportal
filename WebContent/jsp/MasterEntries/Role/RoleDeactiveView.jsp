...
<html>
<head>
<title><%=bundle.getString("label.role.deactivelistlisttitle") %></title>
...
{
if(confirm("Do you want to Activate the Role...?"))
{
...
document.MainForm.action= "RoleActivate.jsp";
document.MainForm.submit();
...
<%@ include file="../../include/header.jsp" %>
    ...
    <div class="right_content">
         <h2><%=bundle.getString("label.role.deactivelistrootpath") %></h2>
...
Role=query_object.get_All_roleDeactivateList(instituteid);
%>
<form name="MainForm" method="post" action="">
...
<TABLE align="center" width="100%" height="100%" border=0 cellspacing=0
    ...
    <thead>
    	<tr>
        	...
        	<th scope="col" class="rounded" width="40%" align="right"><%=bundle.getString("label.role.rolename") %> </th>
  	        	<th scope="col" class="rounded" width="40%" align="right"><%=bundle.getString("label.role.description") %> </th>
  	        	<th scope="col" class="rounded-q4" width="15%" align="right" ><%=bundle.getString("label.role.active") %> </th>
    	...
    	<tr>
        	...
        	<td class="rounded-foot-right">&nbsp;</td>
				...
				{	newRole=(HashMap)Role.get(i);
					...
					out.print("<td class='tablelight'><a href='#' onclick='ActiveFun(this)'  roleid='"+newRole.get("roleid")+"' rolename='"+newRole.get("rolename")+"' description='"+newRole.get("description")+"'>"+bundle.getString("hlink.role.active")+"</td>");
					out.print("</tr>");
				}
				}
				}
