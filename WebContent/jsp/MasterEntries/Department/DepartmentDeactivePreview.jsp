...
{
	document.MainForm.action= "DepartmentDeactive.jsp";
document.MainForm.submit();
}
else{}
}
...
<%@ include file="../../include/header.jsp" %>
    ...
    <div class="right_content">
         <h2><%=bundle.getString("label.department.deactivatepreviewlistrootpath") %> </h2>
...
<TABLE align="center" width="100%" height="100%" border=0 cellspacing=0
    ...
    <thead>
    	<tr>
        	...
        	<th scope="col" class="rounded-company" width="90%"><%=bundle.getString("label.department.deactivatepreviewtableheading") %></th>
    ...
    <thead>
		...
		<a href="#" onclick="goToBack()"class="bt_blue"><span class="bt_blue_lft"></span><strong><%=bundle.getString("button.department.back") %> </strong><span class="bt_blue_r"></span></a>	
			...
			{%>
     <a href="#" class="bt_green" onclick="goToTrash()"><span class="bt_green_lft"></span><strong><%=bundle.getString("button.department.deactivate") %> </strong><span class="bt_blue_r"></strong><span class="bt_green_r"></span></a>
	 <%}
	 else
	 {
		 out.println("<div class='warning_box'>");
	 	out.println("<a align=left class='tablebold'>"+bundle.getString("label.department.deactivatepreviewerrormessagedetails") +"</a>");
		 out.println(" </div>");
