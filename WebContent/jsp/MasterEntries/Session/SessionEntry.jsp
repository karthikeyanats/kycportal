...
document.getElementById("save_but").disabled=true;
	...
	{
			document.MainForm.action= "SessionSubmit.jsp";
...
function resetfun()
{
document.MainForm.sessionname.value="";
...
function checkNames()
{
  	   	 var url = "checkDuplicate.jsp?fieldname="+document.MainForm.sessionname.value;
 	   var req =initRequest();
...
<TABLE align="center" width="100%" height="100%" border=0 cellspacing=0
	...
	<tr>
		<td align="right" class="tablelight"><a href="#" onclick="deptview()">Year of Session View</a></td>
	</tr>
	<tr>
		<td>
<table id="rounded-corner" border=0 summary="Department List" width="100%">
    <thead>
    	<tr>
        	...
        	<th scope="col" class="rounded" width="100%">Year Of Session Creation</th>
...
<table id="rounded-corner" border=0 summary="Department List" width="100%">
    <thead>			<tr>
			...
			<tr>
				...
				<td>
				<textarea validate="Description" cols=50 rows=2 name="descryption" onkeydown="textCounter(document.MainForm.descryption,document.MainForm.remLen2,2000)" onkeyup="textCounter(document.MainForm.descryption,document.MainForm.remLen2,2000)"></textarea>&nbsp; <br><br><input readonly class='tablelight' type="text" name="remLen2" size="3" maxlength="3" value="2000">
