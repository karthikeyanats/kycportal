...
{
	document.MainForm.action= "SessionTrash.jsp";
document.MainForm.submit();
}
else{}
}
...
<%@ include file="../../include/header.jsp" %>
    ...
    <div class="right_content">
         <h2>Master Entries /Session Trash</h2>
...
courseList=query_object.checkStandards(instituteBean);
...
<TABLE align="center" width="100%" height="100%" border=0 cellspacing=0
	...
	<tr>
		...
		<table border=1 width="90%" bordercolor='#e3e3e3' cellpadding=10
			...
			{
				out.println("<tr>");	
				out.println("<td align=center class='tablebold'>Standard List :</td>");
				out.println("<td align=center class='tablelight'>Under This Session Standard has been alloted.so you can not Trash this Session</td>");
				out.println("</tr>");		
			}
			%>
		</table>
		...
		<table border=0 width="90%" cellpadding=0 cellspacing=0 align="center">
			...
			{%>
				<input type="button" name="trashs" class=buttonTab
