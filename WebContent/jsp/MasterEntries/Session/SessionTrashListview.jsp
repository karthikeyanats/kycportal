...
document.MainForm.sessionid.value=sessionid;
document.MainForm.description.value=description;
document.MainForm.action= "SessionDelete.jsp";
document.MainForm.submit();
...
document.MainForm.action= "SessionRestore.jsp";
document.MainForm.submit();
    ...
    <tfoot>
     ...
     <tbody>
				...
				{					newdept=(HashMap)dept.get(i);
					...
					out.println("<td class='tablelight'><a href='#' onclick='DeleteFun(this)'  sessionid='"+newdept.get("sessionid")+"' sessionname='"+newdept.get("sessionname")+"' description='"+newdept.get("description")+"'>Delete</td>");
					out.println("<td class='tablelight'><a href='#' onclick='RestoreFun(this)' sessionid='"+newdept.get("sessionid")+"' sessionname='"+newdept.get("sessionname")+"' description='"+newdept.get("description")+"'>Restore</td>");
...
<input type="text" name="sessionname" value="">
