...
function submitfun()
{
	...
	{
			document.MainForm.action= "SubjectTypeSubmit.jsp";
...
<%@ include file="../../include/header.jsp" %>
    ...
    <div class="right_content">
	       <h2><%=bundle.getString("label.subjecttype.entryrootpath") %></h2>
...
<table id="rounded-corner" border=0 summary="Department List" width="100%">
    <thead>
    	<tr>
        	 ...
        	 <th scope="col" class="rounded-company" width="80%"><%=bundle.getString("label.subjecttype.entrytableheading") %></th>      
...
<table id="rounded-corner" border=0 summary="Department List" width="100%">
    <thead>			<tr valign="top">
				...
				<td class=tablebold>:</td><td><input type="text" name="subjecttypename"
					validate="Subject Type Name" class=tablelight size="50" value=""
					maxlength=100></td> 
			</tr>
			<tr valign="top">
		...
		<a href="#" onclick="resetfun()" class="bt_blue"><span class="bt_blue_lft"></span><strong><%=bundle.getString("button.subjecttype.reset") %></strong><span class="bt_blue_r"></span></a>

     <a href="#" onclick="deptview()"  class="bt_blue"><span class="bt_blue_lft"></span><strong><%=bundle.getString("button.subjecttype.viewallsubjecttype") %> </strong><span class="bt_blue_r"></span></a>
	     <a href="#" class="bt_green" onclick="submitfun()"><span class="bt_green_lft"></span><strong><%=bundle.getString("button.subjecttype.submit") %></strong><span class="bt_green_r"></span></a>
