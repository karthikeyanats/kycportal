...
<jsp:useBean id="validate" scope="page"
	...
	<%@ page import="java.io.*,java.util.ArrayList,java.util.HashMap"%>
				<jsp:useBean id="gradeQuery" scope="page" class="com.iGrandee.MasterEntries.SubjetType.SubjectTypeEntry"/>
...
boolean aa=validate.checkDuplicatewithstatus("subjecttype","subjectypename",fieldname,"subjecttypestatus",instituteid);
try
{
	...
	else if(flage.equals("update"))
	{
		...
		boolean checkString = false;
			...
			if((temp_str=request.getParameter("subjecttypename"))!=null && (temp_str1=request.getParameter("subjecttypeid"))!=null  )
			{
