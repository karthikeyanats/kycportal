...
{
if(confirm("Do you want Active Medium?"))
{
...
document.MainForm.action= "SubjectModeActive.jsp?subjectmodeid="+subjectmodeid+"&subjectmodename="+subjectmodename+"&description="+description;
document.MainForm.submit();
...
<%@ include file="../../include/header.jsp" %>
    ...
    <div class="right_content">
         <h2>Master Entries /Subject Mode Deactive List</h2>
...
<TABLE align="center" width="100%" height="100%" border=0 cellspacing=0
	...
	<tr>
		...
		<table align="center" width="80%"  border=1>
			<tr>
				<td class="tablebold">Sl.No</td><td class="tablebold">Board</td><td class="tablebold">Description</td><td colspan="2" class="tablebold" align="center">Action</td>
				</tr>
				<% 
				...
				{					newdept=(HashMap)dept.get(i);
					...
					out.println("<td class='tablelight'><a href='#' onclick='RestoreFun(this)' subjectmodeid='"+newdept.get("subjectmodeid")+"' subjectmodename='"+newdept.get("subjectmodename")+"' description='"+newdept.get("description")+"'>Active</td>");
