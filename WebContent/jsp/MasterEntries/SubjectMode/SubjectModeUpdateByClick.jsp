...
<html>
<head>
<title>Subject Mode Update</title>
...
if(confirm("Do you want to Update the Details"))
{
	...
	document.MainForm.action= "SubjectModeEditUpdate.jsp";
document.MainForm.submit();
}
}
...
<%@ include file="../../include/header.jsp" %>
    ...
    <div class="right_content">
         <h2>Master Entries /Subject Mode Update</h2>
	...
	<tr>
		...
		<table border=0 width="90%" bordercolor='#e3e3e3' cellpadding=10
			...
			<tr bordercolor=white>
				<td align=center class="tablebold">SubjectType Name :</td>
				<td><input mode="text" name="subjectmodename" validate="Subject Mode Name" value="<%=subjectmodename %>"></td>
			</tr>
			<tr bordercolor=white>
				<td align=center class="tablebold">Description :</td>
								<td><input mode="text" name="deptdescription" value="<%=description1 %>"></td>
				
			</tr>
			
		<tr>	
		<td><input type="hidden" name="subjectmodeid" value="<%=subjectmodeid %>"></td></tr>
