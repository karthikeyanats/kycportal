...
<html>
<head>
<title><%=bundle.getString("label.medium.trashlisttitle") %></title>
...
{
if(confirm("Do you want to Delete the Medium...?"))
{
...
document.MainForm.action= "MediumDelete.jsp";
document.MainForm.submit();
...
{
if(confirm("Do you want to Restore the Medium...?"))
{
document.MainForm.mediumid.value=obj.getAttribute("mediumid");
document.MainForm.mediumname.value=obj.getAttribute("mediumname");
document.MainForm.description.value=obj.getAttribute("description");
document.MainForm.action= "MedumRestore.jsp";
document.MainForm.submit();
...
<%@ include file="../../include/header.jsp" %>
    ...
    <div class="right_content">
         <h2><%=bundle.getString("label.medium.trashlistrootpath") %></h2>
...
Medium=query_object.get_All_mediumTrashList(instituteid);  
%>
...
<TABLE align="center" width="100%" height="100%" border=0 cellspacing=0
    ...
    <thead>
    	<tr> 
        	...
        	<th scope="col" class="rounded" width="35%" align="right"><%=bundle.getString("label.medium.mediumname") %> </th>
  	        <th scope="col" class="rounded" width="35%" align="right"><%=bundle.getString("label.medium.description") %> </th>
  	       <th scope="col" class="rounded" width="10%" align="right"><%=bundle.getString("label.medium.delete") %> </th>
  	       <th scope="col" class="rounded-q4" width=10%" align="right"><%=bundle.getString("label.medium.restore") %> </th>
    	...
    	<tr>
        	...
        	<td class="rounded-foot-right">&nbsp;</td>
				...
				{					newMedium=(HashMap)Medium.get(i);
					...
					out.println("<td class='tablelight'><a href='#' onclick='DeleteFun(this)'  mediumid='"+newMedium.get("mediumid")+"' mediumname='"+newMedium.get("mediumname")+"' description='"+newMedium.get("description")+"'><img src='"+request.getContextPath()+"/jsp/kycpanel/images/user_logout.png' alt='delete' title='"+bundle.getString("label.medium.delete")+"' border='0' /></td>");
					out.println("<td class='tablelight'><a href='#' onclick='RestoreFun(this)' mediumid='"+newMedium.get("mediumid")+"' mediumname='"+newMedium.get("mediumname")+"' description='"+newMedium.get("description")+"'><img src='"+request.getContextPath()+"/jsp/kycpanel/images/16-undo1.png' alt='restore' title='"+bundle.getString("label.medium.restore")+"' border='0' /></td>");
