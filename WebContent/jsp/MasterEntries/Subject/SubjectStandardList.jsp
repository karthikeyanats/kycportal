...
<title><%=bundle.getString("label.product.name") %> - <%=bundle.getString("label.subjectstandard.entrytitle") %> | Powered by i-Grandee</title>
...
function loadStandard()
{
	...
	document.standardForm.action="SubjectStandardList.jsp";
...
<%@ include file="../../include/header.jsp" %>
    ...
    <h2><%=bundle.getString("label.subjectstandard.entryrootpath") %> </h2>
...
<table id="rounded-corner" border=0 summary="Department List" width="100%">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded" width="35%"><%=bundle.getString("label.standard.Description") %></th>
            <th scope="col" class="rounded" width="15%"><%=bundle.getString("label.standard.GroupStatus") %></th>
            <th scope="col" class="rounded-q4" width="15%"><%=bundle.getString("label.standard.Dateofcreation") %></th>
           ...
           <td><%=groupstatus %></td>
            <td><%=stdcreateddate %> </td>
				...
				<%
    	 		...
    	 		{
    	 			out.println("<tr><td colspan=5 align='center'>Select Board</td></tr>");
    	 		}
