			...
			<tr>
				<td align='left' width='100%' height='100%'>
						...
						<table id="rounded-corner" border=0 summary="Department List"
							...
							<thead>
								<tr>
									<th scope="col" class="rounded-company" width="98%">Board
									Details</th>
							...
							<tr>
								...
								<table border='0' align="center" width="100%" cellspacing=0
									cellpadding=5>
									<tr>
									<td  width='30%' class='tablebold'>Current Academic Year </td>
									<td class=tablebold>:</td>
									<td  width='30%'><%= Sessionname%></td>
									
										<td width='20%' class='tablebold'>Board</td>
										<td class=tablebold>:</td><td width='30%'><select name='board'
											validate='Board' onchange='changeBoard()'>
												...
												if(boardList != null && boardList.size()>0){
													for(int y=0;y<boardList.size();y++){
														...
														if(boardid != null && boardid.equals(""+hashmap.get("boardid")))
															out.print("<option selected value='"+hashmap.get("boardid")+"'>"+boardname+"</option>");
														else
...
<tr>
										...
										<%}%>
								<table border='1' id=rounded-corner1  align="center" width="100%" cellspacing=0 cellpadding=5>
											<tr class='tableheading'>
											<td width='15%'>Sl.No</td>
											<td width='45%'>Standard</td><td width='20%'>No Of Present</td><td width='20%'>No Of Absent</td><td width='20%'>Total</td>
											</tr>
											<%
												if(StandardList != null && StandardList.size()>0){
													...
													for(int y=0;y<StandardList.size();y++){
														...
														out.print("<td align=center>"+(y+1)+"</td><td>"+standardname+"<a href='#absent' name='absent' standardscheduleid='"+standid+"' standardname='"+standardname+"' onclick='standarddetails(this)'>    [ Show Standard Wise ]</a></td>");
														...
														String noofabsentees=innermap.get("absentees")+"";
															if(noofabsentees.equals("0"))
																...
																out.print("<td align=center style='background-color:#ffb0b0'><a href='#absent' name='absent' standardscheduleid='"+standid+"' standardname='"+standardname+"' state='A' onclick='Studentdetails(this)'>[ "+noofabsentees+" ]</a></td>");
