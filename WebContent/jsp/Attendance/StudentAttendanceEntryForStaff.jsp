		...
		<br>
			...
			<tr>
				...
				<a href="#" onclick=selcetall()></a>
					<table id="rounded-corner" border=0  width="100%">
					    <thead>
					    	<tr>
					        	...
					        	<th scope="col" class="rounded"   align="center" width="15%"><%=bundle.getString("label.schedule.dateofcreation")%></th>
					            <th scope="col" class="rounded-q4"   	 width="20%"><%=bundle.getString("label.schedule.action")%></th>
							...
							for(int y=0,j=1;y<studentList.size();y++,j++){
								...
								else
								{
									...
									else
									{
										...
										if((sessionusercat!=null && (sessionusercat.equals("SA") || sessionusercat.equals("MA"))) || (sessionuserid!=null && sessionuserid.equals(attendanceby)))
					...
					%>
					<td valign=top>
						Note:</td><td>&nbsp;</td><td> P-Present<br>A-Absent<br>OD-OnDuty<br>Edit|Delete can be done by Created By Staff</br></td>
						</tr>
					</table>
