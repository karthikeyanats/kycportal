...
try
{
	...
	if(pendingFeesList.size()>0)	
     	no_of_rows=feesReportPDF.generatePdf(pendingFeesList,req_sessionid,req_sessionname,req_boardname,instituteid);
	//else 
...
String fullPath=storagepath+instituteid+"/archivalpdfs/"+req_sessionname+"_"+req_sessionid+"/Fees Details"+"/Fees Details "+time_stamp+".pdf" ;
String filepath=instituteid+"/archivalpdfs/"+req_sessionname+"_"+req_sessionid+"/Fees Details"+"/Fees Details "+time_stamp+".pdf" ;
...
//String filepath=storagepath+"PDFReports/Fees List for "+req_sessionname+"--"+req_boardname+".pdf";

//File fs= new File(filepath);
//boolean boo = fs.exists(); 
//String paths  = "/kycportal/OpenDocument?r1=storagepath&r2=PDFReports/Fees List for "+req_sessionname+"--"+req_boardname+".pdf";
