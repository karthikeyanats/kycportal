...
<title>Know Your Child - Fees Report PDF | Powered by i-Grandee</title>
...
<script type="text/javascript">
	...
	document.StudentReport_Form.req_boardid.value=document.StudentReport_Form.board.options[document.StudentReport_Form.board.options.selectedIndex].value;
		...
		var url = "";
		 ...
		 var url = "FeesReportPDFhide.jsp?req_sessionid="+document.StudentReport_Form.req_sessionid.value+"&req_sessionname="+document.StudentReport_Form.req_sessionname.value+"&req_boardid="+document.StudentReport_Form.req_boardid.value+"&req_boardname="+document.StudentReport_Form.req_boardname.value;
...
%>
		...
		<table width='80%' id=rounded-corner align='center' border='0' >
			...
			<tr>
				...
				<th scope="col" class="rounded" width="100%" colspan=5>Fees Report View</th>
