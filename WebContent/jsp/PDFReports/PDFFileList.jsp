...
<%
	...
	String  storagepath = bundle1.getString("storagepath");
...
%>
    ...
    <h2>Reports / Archival Reports/  Archival PDF's / <%=folder%> File's</h2>
						...
						<table width='100%' id=rounded-corner align='center' border='0'  cellspacing=0 cellpadding=0 >
							 <thead>
							    	<tr>
							            ...
							            <th scope="col" class="rounded"  width="25%" ><%=bundle.getString("label.schedule.view")%></th>
							            <th scope="col" class="rounded-q4" width="25%" ><%=bundle.getString("label.schedule.download")%></th>
								...
								<% if(f1.isDirectory())
									{
										...
										out.println("</tr>");
											...
											//out.println("<tr>");
											//out.println("<td align=center colspan=4>"+bundle.getString("label.schedule.datanotfound")+"</td>" );
											//out.println("</tr>");
