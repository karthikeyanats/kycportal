...
<title>Know Your Child - Archival Reports Index | Powered by i-Grandee</title>
...
function viewPDF()
{
	...
	if(document.ApplicantSearch.boardname.options[document.ApplicantSearch.boardname.options.selectedIndex].value =="00")
	{
		...
		document.ApplicantSearch.req_boardid.value  =document.ApplicantSearch.boardname.options[document.ApplicantSearch.boardname.options.selectedIndex].value;
		document.ApplicantSearch.req_boardname.value  =document.ApplicantSearch.boardname.options[document.ApplicantSearch.boardname.options.selectedIndex].text;
		document.ApplicantSearch.action="PDFArchivalView.jsp";
		document.ApplicantSearch.submit();
}

function stdviewPDF()
{
		document.ApplicantSearch.action="PDFReportIndexStdwise.jsp";
		document.ApplicantSearch.submit();
}
</script>
</head>
...
<%@ include file="../include/header.jsp" %>
   ...
   <%@ page import="java.util.ArrayList,java.util.ResourceBundle,java.util.HashMap,com.iGrandee.Application.RegistrationProcess"%>
...
<table id="rounded-corner" border=0 summary="Department List" width="100%">
    <thead>
    	<tr>
        	<th scope="col" class="rounded-company" width="80%"><%=bundle.getString("label.reports.archivalreports")%></th>
 ...
 <tfoot>
	...
	<td class=tablebold width='20%'>
		...
		<%=bundle.getString("label.academicyear.apprsrc")%>&nbsp;<font color=red>*</font>
		<td class=tablebold width='5%'>:</td>
		<td width='25%'>
	...
	<td class=tablebold  width='20%'><%=bundle.getString("label.boardmedium.apprsrc")%>&nbsp;<font color=red>*</font>&nbsp;
	<td class=tablebold width='5%'>:</td>
	<td width='25%'>
...
<a href="#" class="bt_blue" onclick="stdviewPDF()"><span class="bt_blue_lft"></span><strong><%=bundle.getString("label.schedule.standardwisereport")%></strong><span class="bt_blue_r"></span></a>
<a href="#" class="bt_blue" onclick="viewPDF()"><span class="bt_blue_lft"></span><strong><%=bundle.getString("label.schedule.view")%></strong><span class="bt_blue_r"></span></a>
<a href="#" class="bt_green" onclick="genPDF()"><span class="bt_green_lft"></span><strong><%=bundle.getString("label.schedule.submit")%></strong><span class="bt_green_r"></span></a>
