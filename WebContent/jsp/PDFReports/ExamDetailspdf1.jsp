...
ExamList=examQueryallot.LoadExamnameListRK(instituteid,reg_sessionid,boardid); 
//System.out.print(ExamList.size()+"***********"+reg_sessionname+"--"+request.getParameter("req_boardnname")+"***********"+reg_boardnname+"--"+request.getParameter("req_boardname"));
...
String tepfile=storagepath+instituteid+"/archivalpdfs/"+reg_sessionname+"_"+reg_sessionid+"/Exam Details";
File F= new File(tepfile);
boolean boo = F.exists(); 


String paths  = request.getContextPath()+"/OpenDocument?r1=storagepath&r2="+instituteid+"/archivalpdfs/"+reg_sessionname+"_"+reg_sessionid+"/Exam Details"+"/ExamDetails"+tem_date+".pdf";
String paths1="";
