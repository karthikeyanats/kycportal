...
else if(document.f1.condition.value=="studentsearch")
{
document.f1.action="../StudentSearch/StudentSearchNameDobView.jsp";
}
else
{
...
<h2> Search / Student Search / Student Search View / Student Profile / Student Profile Details</h2>
	...
	String boardname				= request.getParameter("req_boardname");
		...
		try {
			...
			//out.println("personid===>>>"+personid);
	 		 masterperson_list = studentquery.Studentpersondetails(personid);
	...
	<td>
		...
		<table border=0 id="rounded-corner" width="100%">
			...
			<tbody>
						...
						<td class="tablelight" ><%=request.getParameter("req_sectionname")%>
						</td>
						</tr>
						
						<tr >
						
						<td class="tablebold" ><%=bundle.getString("label.studentprofile.RollNo")%>
						</td>
						<td class=tablebold width=1%>:</td>
						<!-- <td class="tablelight" style="width: 35%"><%%>sessionname1 -->
						<td class="tablelight" ><%=request.getParameter("req_rollno")%>
						</td>
						<td class="tablebold" >
						</td>
						<td class="tablelight" >
...
<%} %>
	...
	<tr>
	<td>
		<table border=0 id="rounded-corner" width="100%" cellspacing=0 cellpadding=0 >     
			<thead>
				<tr>
					<th scope="col" class="rounded-company" width="1px"></th>
					<th scope="col" class="rounded"  width="100%" colspan=4><%=bundle.getString("label.studentprofile.ContactDetails")%></th>
					<th scope="col" class="rounded-q4" width="10"></th>
			...
			<tr>
			<td width="1px"></td>
				<td width="100%" colspan=5 class="tablebold"><%=bundle.getString("label.studentprofile.CommunicationAddress")%></td>
			</tr>
			<tr height=25>
				<td width="1px"></td>
			...
			<tr height=25>				<td></td>
				...
				<td align=left colspan=5 class="tablebold">Permanent Address</td>
			</tr>

				<tr height=25>
					<td></td>
					<td align=left class="tablebold">Street</td>
			...
			<tbody>
				...
				<tr height=25>
					...
					<tr style="height: 20"><td></td>
						...
						<td class="tablelight" ><%=relation%>
						</td><td></td>
						
					</tr>
					<tr height=25><td></td>
						<td align=left class="tablebold"><%=bundle.getString("label.studentprofile.Parent/GuardianSelfEmployed")%></td>
						<td align=left ><%=self%></td><td></td>
						
					</tr>
					<tr style="height: 20"><td></td>
						<td class="tablebold" style="width: 25%"><%=bundle.getString("label.studentprofile.NameOforganization")%>
						</td>
						<td class="tablelight" style="width: 75%"><%=nameoforganization%>
						</td><td></td>
					</tr>
					<tr style="height: 20"><td></td>
						<td class="tablebold" style="width: 15%"><%=bundle.getString("label.studentprofile.AnnualIncomeRs")%>
						</td>
						<td class="tablelight" ><%=annualincome%>
						</td><td></td>
					</tr>
					<tr style="height: 20"><td></td>
						<td class="tablebold" style="width: 15%"><%=bundle.getString("label.studentprofile.Position")%>
						</td>
						<td class="tablelight"  ><%=position%></td><td></td>
					</tr>
				</tbody>
			</table>
			<br>
	...
	<br>
		<table border=0 id="rounded-corner" width="80%">
			...
			%><tbody>
					...
					<tr style="height: 20"><td></td>
						<td class="tablebold" style="width: 25%"><%=bundle.getString("label.studentprofile.AddressoftheSchool")%>
						</td>
	...
	<td>
		<table border=0 id="rounded-corner" width="80%">
			<thead>
				<tr>
					<th scope="col" class="rounded-company" width="10"></th>
					<th scope="col" class="rounded"  width="100%" colspan=5><%=bundle.getString("label.studentprofile.ExaminationDetails")%></th>
					<th scope="col" class="rounded-q4" width="10"></th>
	...
	<td>
		<table border=0 id="rounded-corner" width="80%">
			<thead>
				<tr>
					<th scope="col" class="rounded-company" width="10"></th>
					<th scope="col" class="rounded"  width="100%" colspan=2><%=bundle.getString("label.studentprofile.VerificationofCertificates")%></th>
					<th scope="col" class="rounded-q4" width="10"></th>
			...
			<tbody>
					...
					<tr style="height: 20"><td></td>
						<td class="tablebold" style="width: 15%"><%=bundle.getString("label.studentprofile.C.C")%>
						</td>
						<td class="tablelight" style="width: 35%"><%=cc%>
						</td><td></td>
					</tr>
					<tr style="height: 20"><td></td>
						<td class="tablebold" style="width: 15%"><%=bundle.getString("label.studentprofile.Spl.Category")%>
						</td>
						<td class="tablelight" style="width: 35%"><%=splcategory%>
						</td><td></td>
						</tr>
						<tr style="height: 20"><td></td>
						<td class="tablebold" style="width: 15%"><%=bundle.getString("label.studentprofile.MedicalCertificate")%>
						</td>
						<td class="tablelight" style="width: 35%"><%=medicalcertificate%>
						</td><td></td>
						</tr>
						<tr style="height: 20"><td></td>
						<td class="tablebold" style="width: 15%"><%=bundle.getString("label.studentprofile.MarkSheet")%>
						</td>
						<td class="tablelight" style="width: 35%"><%=marksheet%>
						</td><td></td>
						</tr>
						<tr style="height: 20"><td></td>
						<td class="tablebold" style="width: 25%"><%=bundle.getString("label.studentprofile.SportsCertificate")%>
						</td>
						<td class="tablelight" style="width: 75%"><%=sportscertificate%>
						</td><td></td>
						</tr>
				</tbody>
			</table>
