...
if(check_ForParticularElements(document.curricularevententryform.yearofsession,"select"))
	...
	document.curricularevententryform.yearofsession_temp.value = document.curricularevententryform.yearofsession.options[document.curricularevententryform.yearofsession.options.selectedIndex].text;
		...
		document.curricularevententryform.action="PhotoGalleryhmview.jsp";
...
var venue=obj.getAttribute("venue");
	...
	window.open("PhotoGallerySlideShow.jsp?reqcurriculareventid="+document.curricularevententryform.reqcurriculareventid.value+"&yearname="+document.curricularevententryform.yearofsession.options[document.curricularevententryform.yearofsession.options.selectedIndex].text+"&categoryname="+document.curricularevententryform.curricularcategory.options[document.curricularevententryform.curricularcategory.options.selectedIndex].text+"&curriculareventname="+curriculareventname+"&eventdate="+eventdate+"&venue="+venue+"&flage=admin","Msg","top=250,left=350,help:no,center:no,status:no,width=1100,height=800,scrollbars=1;")
	

	//document.curricularevententryform.reqcurriculareventid.value = obj.getAttribute("curriculareventid");
	//window.open("PhotoGallerySlideShow.jsp?reqcurriculareventid="+document.curricularevententryform.reqcurriculareventid.value,"Msg","top=250,left=350,help:no,center:no,status:no,width=650,height=800,scrollbars=1;")
...
<%@ include file="../include/header.jsp" %>
    ...
    <h2><%=bundle.getString("label.photogallery.rootpathhmlogin")%>  </h2>
...
<option>-Select Session-</option>
 <%
  		 sessionList =  PhotoGalleryQuery.listYearofSessionHM(instituteid);
...
<table id="rounded-corner" border=0 summary="selectd Information" align=center>
	...
	else
	{
		...
		//out.println("<td colspan=5 align=center class=tablebold><font color=red>Data not found</font></td>");
	}
	}
	else
	{
