...
{
	 document.operationform.action	="./FeesCollection_pre.jsp";
	document.operationform.submit();
}

function getPrint()
{
	window.open("./academicfeesreceipt.jsp?feesreceitpid="+document.operationform.feesreceitpid.value+"&rollnumbertext="+document.operationform.rollnumbertext.value);
}
</script>
</head>
<body>
...
<input type="hidden" name="feesreceitpid" 		value="<%=request.getParameter("feesreceitpid")%>">
