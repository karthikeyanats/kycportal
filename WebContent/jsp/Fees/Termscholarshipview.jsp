...
<script type="text/javascript">
	...
	function SubmitFun()
	{
		alert("Calling SubmitFun");
	if(check_ForParticularElements(document.scholarsip_form.academicyear,"select",document.scholarsip_form.standard_board,"select",document.scholarsip_form.scholarship,"select",document.scholarsip_form.standardname,"select")){
			
			document.scholarsip_form.action		= "Termscholarshipview.jsp";
			document.scholarsip_form.submit();
		}
	}
...
<% 	
	...
	String standardscheduleid       = request.getParameter("standardname");
	out.println("sessionid===>>>"+sessionid);
	out.println("boardid===>>>"+boardid);
	out.println("scholarshipid===>>>"+scholarshipid);
...
<table id="rounded-corner" border=0  width="100%">
    <thead>
    	<tr>
        	<th scope="col" class="rounded-company" width="90%" colspan=8>Allotment</th>
    ...
    <tfoot>
     ...
     <tr>
    	...
    	<tr>
        	<td class=tablebold width="15%">Scholarship</td><td class=tablelight colspan="6">
        
		        <select name="scholarship" class=tablelight validate="Scholarship" onchange=loadStandard()>
          ...
          <td class=tablebold width="15%"> Standard Name</td><td class='tablelight'>
			<select name="standardname" class=tablelight validate="Standard Name"> 
				<option value="0" selected>-Select Standard Name -</option>
	    		<%
	    			...
	    			for (int i = 0; i < standardList.size(); i++)
				{
				 		...
				 		if(standardList != null && standardList.equals((String)hashMap.get("standardscheduleid")))
...
<%--	 <table id="rounded-corner" border=0 summary="selectd Information" width="100%">
   ...
   <a href="#" class="bt_green" onclick="submitAllot()"><span class="bt_green_lft"></span><strong>Save</strong><span class="bt_green_r"></span></a>
