...
function parseMessages(parseXML,check_var,process)
{
	   ...
	   var rootobj=parseXML.getElementsByTagName("complaintdetails");
		...
		{	
		//document.feescollectionpreform.action="./FeesCollectionStudentinfo.jsp";
		document.feescollectionpreform.action="./FeesCollectionStudentinfo_headwise.jsp";
		document.feescollectionpreform.submit();	
		}
		else if(ask=="true" && process=="paidlist")
		{	
		/* document.feescollectionpreform.action="./FeesPaidListStudent.jsp"; */
		 document.feescollectionpreform.action="./FeesPaidListStudentNew.jsp";
		document.feescollectionpreform.submit();	
		}
		else
		{
...
<%@ include file="../include/header.jsp" %>
    ...
    <h2><%=bundle1.getString("label.feescollection.rootpath")%></h2>
...
<table id="rounded-corner" border=0  width="100%">
    ...
    <tr><td colspan=2><table id="rounded-corner1" width="100%">
     ...
     <a href="#" onclick=loadStudent('paidlist') class="bt_blue"><span class="bt_blue_lft"></span><strong><%=bundle1.getString("button.feescollection.FeesPaidList")%> </strong><span class="bt_blue_r"></span></a>

     <a href="#" onclick=loadStudent('collectfees') class="bt_green"><span class="bt_green_lft"></span><strong><%=bundle1.getString("button.feescollection.CollectFees")%> </strong><span class="bt_green_r"></span></a>
