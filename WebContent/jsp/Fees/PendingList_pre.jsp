...
<%@ include file="../include/header.jsp" %>
    ...
    <h2><%=bundle1.getString("label.feesreport.rootpath")%></h2>
...
<table id="rounded-corner" border=0 summary="Department List" width="100%">
    <thead>
    	<tr>
        	<th scope="col" class="rounded-company" width="80%"><%=bundle1.getString("label.feesreport.FeesReport")%></th>
 ...
 <tfoot>
	...
	<td class=tablebold  align=right>
		&nbsp;&nbsp;<b><%=bundle1.getString("label.feesreport.AcademicYear")%> :</b> &nbsp;</td>
		<td align=left>
	...
	<td class=tablebold align=right><%=bundle1.getString("label.feesreport.Board")%> : &nbsp;<font color=red>*</font></td>
	<td align=left>
