...
<body onload='LoadStatus()'>
	...
	<%
		...
		if(result >0)
			if(operation.equals("A"))
				status	= "Scheduled Standard[s] Successfully Restored.";
			else
				status	= "Scheduled Standard[s] Successfully Deleted.";
		else
			if(operation.equals("A"))
				status	= "Scheduled Standard[s] Restoration Failed.";
			else
				status	= "Scheduled Standard[s] Deletion Failed.";
	%>
	...
	<input type='hidden' name='returnurl' 			value='TrashedStandard.jsp'>
