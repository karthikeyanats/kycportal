...
<script type="text/javascript">
	...
	function loadMark(){
		...
		document.Schedule_Form.loadstatus.value	= 'A';
		document.Schedule_Form.submit();
	}
...
<%@ include file="../include/header.jsp" %>
    ...
    <h2><%=bundle.getString("label.schedule.importmarkschedulesubject")%></h2>
<%@ page language="java"
...
<%
		...
		if(loadstatus == null || loadstatus.equals("") || loadstatus.equalsIgnoreCase("null") || loadstatus.equals("0"))
			subjectList		= schedule.viewSubjectsMarks(standardscheduleid);
		else
			subjectList		= schedule.viewSubjectsMarksSubjects(standardscheduleid);
...
<form name="Schedule_Form" action="" method="post">
		...
		<a href="#" class="bt_blue" onclick='loadMark()'><span class="bt_blue_lft"></span><strong><%=bundle.getString("label.schedule.loadmark")%></strong><span class="bt_blue_r"></span></a>
		<br>
										    	...
										    	<td colspan='2'>
													<table border='0' summary="Department List" width="100%" cellpadding='0' cellspacing='0'>
														...
														<tr>
															...
															<td rowspan='3' width='12%' class='tablebold'>Practical</td>
															<td colspan='2' width='11%' align='center' class='tablebold'><%=bundle.getString("label.schedule.internal")%></td>
															<td colspan='2' width='11%' align='center' class='tablebold'><%=bundle.getString("label.schedule.external")%></td>
															<td rowspan='3' width='11%' class='tablebold'>Project</td>
															<td colspan='2' width='11%' align='center' class='tablebold'><%=bundle.getString("label.schedule.internal")%></td>
															<td colspan='2' width='11%' align='center' class='tablebold'><%=bundle.getString("label.schedule.external")%></td>
														</tr>
														<tr>
		...
		<%if(loadstatus != null && loadstatus.equals("A") ){ %>
		...
		<input type='hidden' name='returnpage' 					value='ImportMarkScheduleSubject.jsp'>
		<input type='hidden' name='loadstatus' 					value=''>
