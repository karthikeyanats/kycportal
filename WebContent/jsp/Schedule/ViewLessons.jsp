...
<%@ include file="../include/header.jsp" %>
    ...
    <h2><%=bundle.getString("label.schedule.scheduledlessons")%></h2>
<%@ page language="java"
					    		...
					    		for(int y=0;y<subjectList.size();y++){
									...
									if(status.equals("Yes")){
										if(archival != null && archival.equals("R"))
											...
											out.print("<td>Scheduled</td><td><a href='#' lessonname='"+hashmap.get("lessonname")+"' lessonid='"+hashmap.get("lessonid")+"' lessonscid='"+hashmap.get("lessonscheduleid")+"' status='D' onclick='lessonTrash(this)'><img src='"+request.getContextPath()+"/jsp/kycpanel/images/trash.png' alt='Trash' title='Trash' border='0' /></a></td></tr>");
									}
						    		else{
										if(archival != null && archival.equals("R"))
							    			out.print("<td>New</td><td>-</td></tr>");
										else
							    			out.print("<td>New</td><td><a href='#' lessonid='"+hashmap.get("lessonid")+"' lessonscid='"+hashmap.get("lessonscheduleid")+"' status='A' onclick='activate(this)'>Allocate</a></td></tr>");
						    		}
					    		}
					    	}
					    	else{
