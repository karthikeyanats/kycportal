...
<title>Know Your Child - Promoted Student Allocation Process | Powered by i-Grandee</title>
...
<script type="text/javascript">
	...
	function viewStudent()
	{
		...
		else
		{
			...
			document.ApplicantSearch.action="ViewPromoStudents.jsp";
			document.ApplicantSearch.submit();
		}
...
<%@ include file="../include/header.jsp" %>
	...
	<table id="rounded-corner" border=0 summary="Department List" width="100%">
    	<thead>
    		<tr>
            	<th scope="col" class="rounded-company" width="80%">Promoted Student Allocation</th>
            	<th scope="col" class="rounded-q4" width="20%"><font color=red>*</font> 
<%=bundle.getString("label.common.mandatory") %></th>        
        	</tr>
    	</thead>
