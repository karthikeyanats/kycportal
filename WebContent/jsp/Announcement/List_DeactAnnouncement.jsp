...
<title>Know Your Child - <%=bundle.getString("label.announcement.deactivelisttitle") %>  | Powered by i-Grandee</title>
...
document.frm.mode_of_operation.value="Active";
...
<%@ include file="../include/header.jsp" %>
    ...
    <h2><%=bundle.getString("label.announcement.deactivelistrootpath") %></h2>
...
<table id="rounded-corner" border=0 summary="Department List" width="100%" cellspacing=0
    ...
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded" width="50%"> <%=bundle.getString("label.announcement.contentname") %></th>
            <th scope="col" class="rounded" width="13%"><%=bundle.getString("label.announcement.dateofcreation") %></th>
            <th scope="col" class="rounded-q4" width="8%" ><%=bundle.getString("label.announcement.activated") %></th>
          </tr>
    </thead>
     <tfoot>
    	<tr>
		  	...
		  	String[] count=null;
				if(no_of_rows != null && no_of_rows.size()>0)
				{
					...
					{		out.println("<tr valign='top'>");
						...
						out.println("<td class='tablelight'><a href='#' onclick=actionfun('Active',this) contentid='"+hm.get("announcementid")+"' content='"+hm.get("annoucementdetails")+"' >"+bundle.getString("hlink.announcement.active")+"</td>");
				...
				else
				{
					...
					//out.println("<tr><td align=center colspan=4>Data Not Found</td></tr>");
				}
		  	%>
