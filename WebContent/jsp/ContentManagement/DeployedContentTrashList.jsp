...
<script type="text/javascript">
	...
	{
		if(confirm("You Want To Redeploy The Content"))
		{
	...
	function goBack()
	{
		document.Content_Form.action = "./DeployedContentViewLesson.jsp";
		document.Content_Form.submit();
	}
...
<%@ include file="../include/header.jsp" %>
    ...
    <h2>Content Management / Standard Subject View / Deployed Content / Trash List</h2>
<%@ page language="java"
...
ArrayList contentlist=query.LoadDeployedContentLesson(req_lessonid,request.getParameter("lessonscheduleid"),"T");
%>
						...
						try{
							if(contentlist.size()>0)
							{
								for(int y=0,sno=1;y<contentlist.size();y++)
								{
													...
													out.print("<td><a href='#' rwno='"+y+"' cmscontentid='"+cmscontentid+"' cmscontentscheduleid='"+cmscontentscheduleid+"' onclick='contentrestore(this)' ><img src='"+request.getContextPath()+"/jsp/kycpanel/images/16-undo1.png' alt='Trash' title='Trash' border=0 /></a></td>");
													out.print("<td></td>");
													out.print("</tr>");
													sno++;
								}
