<html>
<%
   String subjectId=(String)session.getValue("SubjectList");
	String subjectname=(String)session.getValue("subjectname");
...
<frameset frameborder="11" framespacing="0"  cols="*" rows="75,*">
    ...
    <%
     ...
     %>
		...
		<frame marginwidth="5" marginheight="5" src="http://local.khanacademy.org" name="clientpanel" noresize>
		</frameset>
