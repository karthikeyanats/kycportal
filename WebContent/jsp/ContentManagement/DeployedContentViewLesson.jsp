...
<script type="text/javascript">
	...
	{
		if(confirm("You Want To Trash The Deployed Content"))
		{
		    ...
		    document.Content_Form.cmscontentscheduleid.value=obj.getAttribute("cmscontentscheduleid");
			document.Content_Form.action = "./DeployedContentTrashSubmit.jsp";
			document.Content_Form.submit();
		}
	}
	function contentdelete(obj)
	{
		if(confirm("You Want To Delete The Deployed Content"))
		{
	...
	{
		document.Content_Form.action = "./DeployedContentTrashList.jsp";
		document.Content_Form.submit();
	}
	function goBack()
	{
...
<%@ include file="../include/header.jsp" %>
    ...
    <h2>Content Management / Standard Subject View / Deployed Content</h2>
<%@ page language="java"
...
ArrayList contentlist=query.LoadDeployedContentLesson(req_lessonid,request.getParameter("lessonscheduleid"),"A") ;
%>
		...
		<table id="rounded-corner" border=0 summary="Department List" width="80%">
		    ...
		    <tr>
		    	<td colspan='3'>
					...
					<input type='hidden' name=cmscontentscheduleid	value=''>	
		...
		<table width='100%' id="rounded-corner" align='center' border='0' >
									...
									<tr>
									        	...
									        	<th scope="col" class="rounded" width="40%" >Notes</th>
						...
						try{
							if(contentlist.size()>0)
							{
								for(int y=0,sno=1;y<contentlist.size();y++)
								{
												    ...
												    String cmscontentscheduleid=map.get("cmscontentscheduleid")+"";
													...
													out.print("<td><a href='#' rwno='"+y+"' cmscontentid='"+cmscontentid+"' cmscontentscheduleid='"+cmscontentscheduleid+"' onclick='contenttrash(this)' ><img src='"+request.getContextPath()+"/jsp/kycpanel/images/trash.png' alt='Trash' title='Trash' border=0 /></a></td>");
													out.print("<td><a href='#' rwno='"+y+"' cmscontentid='"+cmscontentid+"' cmscontentscheduleid='"+cmscontentscheduleid+"' onclick='contentdelete(this)' ><img src='"+request.getContextPath()+"/jsp/kycpanel/images/user_logout.png' alt='Delete' title='Delete' border=0 /></a></td>");
													out.print("<td></td>");
													out.print("</tr>");
													sno++;
								}
			...
			<a href="#" class="bt_red" onclick='trashlistfun()'><span class="bt_red_lft"></span><strong>Trash List</strong><span class="bt_red_r"></span></a>
