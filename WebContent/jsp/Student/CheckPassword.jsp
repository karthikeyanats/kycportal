...
if(confirm("Do you want to Change the Password"))
{
	document.f1.action = "./SubmitPassword.jsp";
	document.f1.submit();
}
...
<h2><%=bundle.getString("label.studpswchange.rootpath_2")%></h2>
...
<TABLE align="center" width="100%" height="100%" BORDER=0 CELLSPACING=0
	...
	<tr>
		...
		<table id="rounded-corner_home" border=0   
			...
			<thead>
				<tr>
					<th scope="col" class="rounded-company" width="80%"><%=bundle.getString("label.studpswchange.ChangePassword")%></th>
...
<table border=0 cellpadding=5 cellspacing=0 width="100%" align=center>
	<tr><td class=tablebold><%=bundle.getString("label.studpswchange.OldPassword")%></td><td><input type=password class=tablelight name=oldpassword maxlength=25> <A class=tabledivision><font color=red>*</font> <%=bundle.getString("label.studpswchange.25charactersonly")%></a></td></tr>
	<tr><td class=tablebold><%=bundle.getString("label.studpswchange.NewPassword")%></td><td><input type=password class=tablelight name=newpassword maxlength=25> <A class=tabledivision><font color=red>*</font> <%=bundle.getString("label.studpswchange.25charactersonly")%></a></td></tr>
	<tr><td class=tablebold><%=bundle.getString("label.studpswchange.ConfirmPassword")%></td><td><input type=password class=tablelight name=confirmpassword maxlength=25> <A class=tabledivision><font color=red>*</font> <%=bundle.getString("label.studpswchange.25charactersonly")%></a></td></tr>
<tr><td class=tablebold colspan=2><a href="#na2" name="na2" class="bt_blue" onclick="backfun()"><span class="bt_blue_lft"></span><strong><%=bundle.getString("button.studpswchange.Back")%></strong><span class="bt_blue_r"></span></a><a href="#na2" name="na2" class="bt_green" onclick="Submitfun()"><span class="bt_green_lft"></span><strong><%=bundle.getString("button.studpswchange.Submit")%></strong><span class="bt_green_r"></span></a></td></tr>
</table>
<%}
else
{%>
...
<tr><td class=tablebold ><a href="#na2" name="na2" class="bt_blue" onclick="backfun()"><span class="bt_blue_lft"></span><strong><%=bundle.getString("button.studpswchange.Back")%></strong><span class="bt_blue_r"></span></a></td></tr>
</table>
<%}
}
					catch(Exception e)
