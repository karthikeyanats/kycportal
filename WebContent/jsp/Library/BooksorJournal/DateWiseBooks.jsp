...
{var status=false;
	...
	if(status)
	{
		document.MainForm.flage.value="DateWise";
...
<%@ include file="../../include/header.jsp" %>
    ...
    <div class="right_content">
         <h2><%=bundle.getString("label.datewisebooksearch.entryrootpath")%></h2>
...
<table id="rounded-corner" border=0 summary="Department List" width="100%">
    <thead>
    	<tr>
        	...
        	<th scope="col" class="rounded-company" width="40%"><%=bundle.getString("label.datewisebooksearch.entrytableheading") %></th>
...
<table id="rounded-corner" border=0 summary="Department List" width="100%">
    ...
    <thead>
    		<tr valign="top">
            <td class="tablebold" valign="top"><%=bundle.getString("label.datewisebooksearch.StartDate") %>
            </td>
			...
			<td class="tablebold" valign="top"><%=bundle.getString("label.datewisebooksearch.EndDate") %>
            </td>
            <td class="tablebold" width="1%">:</td>
             <td>
