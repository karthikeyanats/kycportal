...
<div id="main_container">
	...
	{
		BookList=query_object.get_All_BookExceedDuedate(startdate,enddate,sessionid,"bookMaster",instituteid); 
	}
	else if(flage_temp.equals("Journal"))
	{
		JournalList=query_object.get_All_BookExceedDuedate(startdate,enddate,sessionid,"Journal",instituteid);  
