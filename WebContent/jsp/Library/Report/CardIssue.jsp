...
function submitfun()
{
	if(document.MainForm.selectoption[0].checked || document.MainForm.selectoption[1].checked)
	{
		...
		{
			document.MainForm.action="./CardIssueStandard.jsp";
			document.MainForm.submit();
		}
		else if(document.MainForm.selectoption[1].checked)
		{
			document.MainForm.action="./CardIssueStaff.jsp";
			document.MainForm.submit();
		}
	}
	else
...
<%@ include file="../../include/header.jsp" %>
    ...
    <div class="right_content">
         <h2><%=bundle.getString("label.cardissue.entryrootpath")%></h2>
...
<table id="rounded-corner" border=0 summary="Department List" width="100%">
    <thead>
    	<tr>
        	...
        	<th scope="col" class="rounded-company" width="40%"><%=bundle.getString("label.cardissue.entryrootpath") %></th>
...
<br>
     ...
     <a href="#" class="bt_green" onclick="submitfun()"><span class="bt_green_lft"></span><strong><%=bundle.getString("button.cardissue.Submit")%></strong><span class="bt_green_r"></span></a>
