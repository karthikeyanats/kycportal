...
<html>
<head>
<title><%=bundle.getString("label.datewisebookissue.entrytitle") %></title>
...
{var status=false;
	...
	if(status)
	{
		document.MainForm.action= "IssuedBookJournalSearch.jsp";
...
<%@ include file="../../include/header.jsp" %>
    ...
    <div class="right_content">
         <h2><%=bundle.getString("label.datewisebookissue.entryrootpath")%></h2>
...
<table id="rounded-corner" border=0 summary="Department List" width="100%">
    <thead>
    	<tr>
        	...
        	<th scope="col" class="rounded-company" width="40%"><%=bundle.getString("label.datewisebookissue.entrytableheading") %></th>
...
<table id="rounded-corner" border=0 summary="Department List" width="100%">
    ...
    <thead>
    		<tr valign="top">
            <td class="tablebold" valign="top"><%=bundle.getString("label.datewisebookissue.StartDate") %>
            </td>
			...
			<td class="tablebold" valign="top"><%=bundle.getString("label.datewisebookissue.EndDate") %>
            </td>
            <td class="tablebold" width="1%">:</td>
             <td>
...
<br>
     ...
     <a href="#" class="bt_green" onclick="submitfun()"><span class="bt_green_lft"></span><strong><%=bundle.getString("button.datewisebookissue.SearchBook")%></strong><span class="bt_green_r"></span></a>
