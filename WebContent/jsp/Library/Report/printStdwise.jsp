...
<div id="main_container">
    ...
    <%
	String sectionscheduleid = request.getParameter("req_sectionschedid");
...
<table border=0 width="100%">
    		<tr valign="top">
            <td class="tablebold" valign="top" width="30%">
				<%				
				if(flage_temp.equals("Book"))
				{
				   out.print("<b>Book Exceed Due Date List</b>");
				   
				}
				else if(flage_temp.equals("Journal"))
				{
				   out.print("<b>Journal Exceed Due Date List</b>");
...
<table border=0 width="100%">
    		<tr valign="top">
            <td class="tablebold" valign="top" width="20%"><b><%=bundle.getString("label.academicyear.apprsrc") %></b>
            </td>
            <td class="tablebold" width="1%">:</td>
            <td width="20%" class="tablelight">
           <%=request.getParameter("req_sessionname") %>
			</td>					
			<td class="tablebold" valign="top"  width="20%"><b><%=bundle.getString("label.board.apprsrc") %></b>
            </td>
               <td class="tablebold" width="1%">:</td>
             <td  width="20%" class="tablelight">
    		...
    		<tr valign="top">
            <td class="tablebold" valign="top" width="20%"><b><%=bundle.getString("label.standard.apprsrc") %></b>
            </td>
            <td class="tablebold" width="1%">:</td>
            <td width="20%" class="tablelight">
           <%=request.getParameter("req_standardnamegp") %>
			</td>					
			<td class="tablebold" valign="top"  width="20%"><b><%=bundle.getString("label.section.apprsrc") %></b>
            </td>
               <td class="tablebold" width="1%">:</td>
             <td  width="20%" class="tablelight">
...
<TABLE align="center" width="100%" height="100%" border=1 cellspacing=0 cellpadding=0>    <thead>
    	<tr class=tableheading  >
            ...
            <th scope="col" class="rounded" width="10%"  rowspan=2><%=bundle.getString("label.bookreturn.AccessNo") %></th>
             ...
             <th scope="col" class="rounded" width="11%"  rowspan=2>Expected<br><%=bundle.getString("label.bookreturn.ReturnDate") %></th>
