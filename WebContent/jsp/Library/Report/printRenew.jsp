...
<table border=0 width="100%">
            ...
            <td class="tablebold" valign="top" width="20%">
				...
				if(flage_temp.equals("Book"))
				{
				   out.print("<b>Book Renewal List</b>");
				   
				}
				else if(flage_temp.equals("Journal"))
				{
				   out.print("<b>Journal Renewal List</b>");
...
%>
   ...
   <TABLE align="center" width="100%" height="100%" border=1 cellspacing=0 cellpadding=0>
    <thead>
    	<tr class=tableheading  >
            ...
            <th scope="col" class="rounded" width="10%"  rowspan=2><%=bundle.getString("label.bookrenewal.AccessNo") %></th>
             ...
             <th scope="col" class="rounded" width="11%"  rowspan=2><%=bundle.getString("label.bookrenewal.RenewalDate") %></th>
