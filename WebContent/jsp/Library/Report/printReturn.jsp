...
<div id="main_container">
	...
	{
		BookList=query_object.get_All_BookReturn(startdate,enddate,sessionid,"bookMaster",instituteid); 
	}
	else if(flage_temp.equals("Journal"))
	{
		JournalList=query_object.get_All_BookReturn(startdate,enddate,sessionid,"Journal",instituteid);  
...
<table border=0 width="100%">
            ...
            <td class="tablebold" valign="top" width="20%">
				...
				if(flage_temp.equals("Book"))
				{
				   out.print("<b>Book Return List</b>");
				   
				}
				else if(flage_temp.equals("Journal"))
				{
				   out.print("<b>Journal Return List</b>");
    ...
    <thead>
    	<tr class=tableheading  >
            ...
            <th scope="col" class="rounded" width="10%"  rowspan=2><%=bundle.getString("label.bookreturn.AccessNo") %></th>
             ...
             <th scope="col" class="rounded" width="11%"  rowspan=2><%=bundle.getString("label.bookreturn.ReturnDate") %></th>
