...
String rackcount		= query_object.checkTrashRacks(rackid);
...
<TABLE align="center" width="100%" height="100%" border=0 cellspacing=0
    ...
    <thead>
	 ...
	 else
	 {
	 	...
	 	out.println("<a align=left class='tablebold'>"+bundle.getString("label.rack.trashpreviewerrormessagedetails") +"</a>");
		 out.println(" </div>");
