...
<html>
<head>
<title><%=bundle.getString("label.rack.trashlisttitle") %> </title>
...
function goback()
{
document.MainForm.action= "RackList.jsp";
document.MainForm.submit();
}
         
function editByClickFun(obj,status)
{
	if(confirm("Do you want to "+status+" the Rack Details...?"))
	{
...
<%@ include file="../../../include/header.jsp" %>
    ...
    <div class="right_content">
         <h2><%=bundle.getString("label.rack.trashlistrootpath") %></h2>
...
<%
	...
	ArrayList RackList		= query_object.get_All_Rack(instituteid,"T");
%>
...
<TABLE align="center" width="100%" height="100%" border=0 cellspacing=5
    ...
    <thead>
    	<tr>
        	...
        	<th scope="col" class="rounded" width="30%"><%=bundle.getString("label.rack.rackname") %> </th>
  	        	...
  	        	<th scope="col" class="rounded" width="5%"><%=bundle.getString("label.rack.delete") %> </th>
  	        	<th scope="col" class="rounded-q4" width="5%"><%=bundle.getString("label.rack.restore") %> </th>
    ...
    <tfoot>
    	<tr>
        	...
        	<td class="rounded-foot-right">&nbsp;</td>
				...
				{	String as=request.getContextPath();					
					...
					for(int i=0,j=1;i<RackList.size();i++,j++)
					{
						...
						out.print("<td class='tablelight'><a href='#'    rackid='"+RackListHash.get("rackid")+"'  onclick=editByClickFun(this,'Delete')><img src='"+request.getContextPath()+"/jsp/kycpanel/images/user_logout.png' alt='delete' title='Delete' border='0' /></a></td>");
						out.print("<td class='tablelight'><a href='#'   rackid='"+RackListHash.get("rackid")+"'   onclick=editByClickFun(this,'Restore')><img src='"+request.getContextPath()+"/jsp/kycpanel/images/16-undo1.png' alt='restore' title='Restore' border='0' /></a></td>");
		   ...
		   <a href="#" onclick="goback()" class="bt_blue"><span class="bt_blue_lft"></span><strong><%=bundle.getString("button.rack.back") %> </strong><span class="bt_blue_r"></span></a>
