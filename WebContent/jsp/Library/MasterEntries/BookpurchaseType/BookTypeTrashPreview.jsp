...
<%
	...
	String booktypecount		= query_object.checkTrashBookType(bookpurchasetypeid); 
...
<TABLE align="center" width="100%" height="100%" border=0 cellspacing=0
    ...
    <thead>
	 ...
	 else
	 {
	 	...
	 	out.println("<a align=left class='tablebold'>"+bundle.getString("label.bookpurchasetype.trashpreviewerrormessagedetails") +"</a>");
		 out.println(" </div>");
