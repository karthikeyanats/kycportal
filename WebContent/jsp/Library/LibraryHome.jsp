...
<form name='wprkallotment' method='post'><input type="hidden"
	...
	<table border='0' align="center" width="100%" cellspacing=0	cellpadding=5 align=left >
									<tr>
										<td width='50%' class='tablebold' align=right><%=bundle.getString("label.adminportal.CurrentAcademicYear") %></td>
	...
	<tr>
		<td width="60%" valign="top" >
			<table border=0 cellpadding=0 cellspacing=0 width="100%" id="rounded-corner_home" >
				 <thead>
				<tr valign="top">
		        	<th scope="col" class="rounded-company" width="100%"><%=bundle.getString("label.adminportal.Services") %></th>
		        ...
		        <tr>
		     	<td colspan=3>
			     	<table border=0 cellpadding=0 cellspacing=0 width="100%">
			     		<tr align=center><td><img src="<%=request.getContextPath()%>/jsp/kycpanel/images/libnewarrival.png" title="New Arrival" border=0></img></td><td><img src="<%=request.getContextPath()%>/jsp/kycpanel/images/libsearch.png" title="Search" border=0></img></td></tr>
			     		<tr align=center class=tablebold><td><a href="<%=request.getContextPath()%>/jsp/Library/BooksorJournal/NewArrivalBook.jsp">New Arrival</a></td><td><a href="<%=request.getContextPath()%>/jsp/Library/Search/SimpleSearch.jsp">Search</a></td></tr>
			     		
						<tr align=center><td colspan=2 align=center><img src="<%=request.getContextPath()%>/jsp/kycpanel/images/libreport.png" title="Report" border=0></img></td>
						<!--  <td><img src="<=request.getContextPath()%>/jsp/kycpanel/images/Fees.png" title="Fees Collection" border=0></img></td>-->
						</tr>
						<tr align=center class=tablebold><td colspan=2 align=center><a href="<%=request.getContextPath()%>/jsp/Library/Report/CardIssue.jsp" title="Today Student Absentees">Report</a></td>
						<!--  <td><a href="<=request.getContextPath()%>/jsp/Fees/FeesCollection_pre.jsp">Fees Collection</a></td>-->
						</tr>
	 ...
	 <thead>
	<tr valign="top">
	<th scope="col" class="rounded-company" width="80%"><%=bundle.getString("label.adminportal.Profile") %></th>
	<th scope="col" class="rounded-q4" width="20%" ></th>
...
<table border='0' align="center" width="100%" cellspacing=0
	 ...
	 <thead>
	<tr>
	<th scope="col" class="rounded-company" width="80%"><%=bundle.getString("label.adminportal.Circular") %></th>
	<th scope="col" class="rounded-q4" width="20%" ></th>
...
<table border='0' align="center" width="100%" cellspacing=0
	 ...
	 <thead>
	<tr>
	<th scope="col" class="rounded-company" width="80%"><%=bundle.getString("label.adminportal.Announcement") %></th>
	<th scope="col" class="rounded-q4" width="20%" ></th>
...
<input type="hidden" name="backward" value="libraryhome"/>
