...
if(flage.equals("null")) 
	...
	if(flage.equals("Book"))
	{
		...
		if(typedbookname!=null && !typedbookname.equals("")&& !typedbookname.equals("null") && !typedbookname.equalsIgnoreCase("null"))
		{
			...
			{
			BookList_book=query_object.get_Keyword_Books(sessionid,"bookMaster",instituteid,typedbookname);   
			}
			else
			{
				flage_msg=true;
...
<%@ include file="../../include/header.jsp" %>
    ...
    <%
        ...
        out.print("<h2>"+bundle.getString("label.keywordsearch.entryrootpath")+" / "+flage+"</h2>");
...
<table id="rounded-corner" border=0  width="100%">
	...
	<tr>
		<td  class="tablebold" width="20%"><%=bundle.getString("label.keywordsearch.keyword") %>
		</td>
...
<tr><td colspan=2 class="tablebold"><=bundle.getString("label.keywordsearch.searchedbooknames") %></td></tr>
</table>-->
 	<table id="rounded-corner" border=0  width="100%">
    <thead>
    	<tr> 
            ...
            <th scope="col" class="rounded" width="20%"><%=bundle.getString("label.receivedbook.Edition") %> </th>
      	    <th scope="col" class="rounded-q4" width="25%"><%=bundle.getString("label.keywordsearch.Availability") %> </th>
...
<br>
		<table width="100%" align="center">
<tr><td colspan=2 class="tablebold"><%=bundle.getString("label.keywordsearch.searchedjournalnames") %></td></tr>
</table>
 	<table id="rounded-corner" border=0  width="100%">
    <thead>
    	<tr> 
...
<%	} %>
		 ...
		 <a href="./KeywordSearch.jsp"  class="bt_blue"><span class="bt_blue_lft"></span><strong><%=bundle.getString("button.cardissue.back") %> </strong><span class="bt_blue_r"></span></a>
