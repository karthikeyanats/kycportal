...
var len1=values.length;
		...
		document.MainForm.action= "SimpleSearchList.jsp";
		document.MainForm.submit(); 
		}
		}
		else
...
<%@ include file="../../include/header.jsp" %>
    ...
    out.print("<h2>"+bundle.getString("label.simplesearch.entryrootpath")+"</h2>");
...
<table id="rounded-corner" border=0  width="100%">
    <thead>
    	<tr> 
        	<th scope="col" class="rounded-company" width="20%"><%=bundle.getString("label.simplesearch.simplebooksearch") %></th>
    ...
    <tbody>
    <tr >
    <td class="tablebold" width="20%" align="center"><%=bundle.getString("label.receivedbook.Title")%> </td><td class="tablebold" width="1%">:</td><td width="20%" class="tablelight" colspan=4><input type="text" name="typedbookname" validate="Book Title " maxlength='100' value=""></td>
    </tr>
    </tbody>
    <tfoot>
    	<tr>
...
else if(flage.equals("Journal"))
{
    ...
    <thead>
    	<tr> 
        	<th scope="col" class="rounded-company" width="20%"><%=bundle.getString("label.simplesearch.simplejournalsearch") %></th>
        	<th scope="col" class="rounded" width="1%"> </th>
        	 <th scope="col" class="rounded" width="20%"> </th>
        	<th scope="col" class="rounded" width="20%"> </th>
        	<th scope="col" class="rounded" width="1%"> </th>
