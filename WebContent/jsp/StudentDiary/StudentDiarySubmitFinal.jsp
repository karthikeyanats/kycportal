...
function loadResult()
{
	document.communityform.action="<%=request.getContextPath()%>/jsp/Opreation_result_withrequest.jsp";
	document.communityform.submit();
}
</script>
</head>
...
String studentreplyremarks="";
String userid=(String)session.getValue("userid");
diaryallocationid=request.getParameter("diaryallocationid");
studentreplyremarks=request.getParameter("studentreplyremarks");
//System.out.println("*userid*******"+userid+diaryallocationid+studentreplyremarks);
...
instituteBean.setstudentreplyremarks(studentreplyremarks);
