...
function applicationView(obj)
{
	...
	document.approvalForm.action="ApplicationReportDatewiseView.jsp";
	document.approvalForm.submit();
}
...
<table id="rounded-corner" border=0 summary="Department List" width="100%">
    <thead>
	 ...
	 //com.iGrandee.Fees.FeesSchedule  feesscheduleQuery = new com.iGrandee.Fees.FeesSchedule();
		...
		applicationCountList	=	(ArrayList)applicationQuery.getReport(request.getParameter("req_sessionid"),request.getParameter("req_boardid"),instituteid,request.getParameter("appFrom"),request.getParameter("appTo"),"Application");
...
<tr>
	<td class=tablebold width="25%"><%=bundle.getString("label.applicationreport.FromDate")%></td><td class=tablebold width='2%'>:</td><td class=tablelight ><%=fromDate%></td>
	<td class=tablebold><%=bundle.getString("label.applicationreport.ToDate")%></td><td class=tablebold width='2%'>:</td><td  colspan=2  class=tablelight><%=toDate %></td>
</tr>
<% 
