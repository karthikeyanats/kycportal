...
<title>Know Your Child - Approval Deactivated List | Powered by i-Grandee</title>
							...
							if (req.readyState == 4)
							   {
								//   alert(req.status)
							  		 if(req.status == 200)
									 {
											...
											if(finalValue=="1")
											{
												alert("This Application No. Already Exist in Approved List.You cant Activate")
											}
											else
											{
...
<%@ include file="../include/header.jsp" %>
    ...
    <h2>Enrollment / Student Enrollment / Approval / Deactivated Approval View</h2>
...
<table id="rounded-corner" border=0 summary="Department List" width="100%" align="center">
   <thead>
    	<tr>
            ...
            <th scope="col" class="rounded" width="25%">Date of DeActivation</th>
    ...
    <tfoot>
     ...
     try
     {
    	  ...
    	  applicantList = applicationQuery.loadApprovedList(request.getParameter("standardpublishid"),"D");
    	...
    	//scholarshipcategoryid,categoryname
    	 if(applicantList!=null && applicantList.size()>0)
            ...
            {
            %>            
            <td><a href="#"  studentapprovalid="<%=studentapprovalId%>" applicantname="<%=applicantName %>" applicationno="<%=applicationNo %>" statusval="Activate" status="A" onclick="statusChangeFun(this)" class="ask">Activate</a></td>
            <%
            }
            else
            {
