...
<title><%=bundle.getString("label.admisionreport.title")%></title>
</head>
...
%>
		...
		<tr>
		<td valign=top align=center><u><%=bundle.getString("label.admisionreport.title")%></u>
		</td>
		</tr>						
		<tr><td>
...
<td>
	...
	<tr>
		<td class=tablebold width="25%"><%=bundle.getString("label.admisionreport.AcademicYear")%></td><td class=tablebold width='2%'>:</td><td class=tablelight ><%=request.getParameter("req_sessionname") %></td>
	...
	%>
							<tr>
							<td width='25%' class='tablebold' ><%=bundle.getString("label.admisionreport.ArchivalDetails")%></td>
							<td class=tablebold width='2%'>:</td>
							<td class='tablelight' align=left colspan=3>
								<h2><%=bundle.getString("label.admisionreport.message")%></h2>
							</td>
						</tr>
	<%}%>						
...
//out.print(request.getParameter("req_sessionid")+"--"+request.getParameter("req_boardid")+"--"+request.getParameter("standardpublishid")+"--"+"A"+"--"+request.getParameter("appFrom")+"--"+request.getParameter("appTo")+"--"+instituteid);	
    	  ...
    	  applicantList = registrationProcess.loadAdmittedList(request.getParameter("standardpublishid"),instituteid,"A");
