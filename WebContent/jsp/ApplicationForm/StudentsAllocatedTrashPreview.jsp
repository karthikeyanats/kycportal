...
<%@ include file="../include/header.jsp" %>
    ...
    <h2>Enrollment / Student Enrollment / Allocation Trash Preview</h2>
...
<tr><td colspan="2" ><table border=0 align=center id="rounded-corner1" width="100%">
	<td class=tablebold width="15%">Academic Year</td><td align=left width="35%" colspan=2  class=tablelight><%=request.getParameter("req_sessionname") %></td>
	<td class=tablebold width="15%">Board</td><td align=left width="35%" class=tablelight><%=request.getParameter("req_boardname") %></td>
</tr>
<tr>
	<td class=tablebold width="15%">Standard</td><td align=left width="35%" colspan=2  class=tablelight><%=request.getParameter("standardnamegp") %></td>
	<td class=tablebold width="15%">Section</td><td align=left width="35%" class=tablelight><%=request.getParameter("req_sectionname") %></td>
</tr>
</table>
</td></tr>
</table>
...
<table id="rounded-corner" border=0 summary="Department List" width="100%">
	...
	<tr>
		...
		<td class=tablebold width="20%">Date of Allocation</td><td class=tablebold width='2%'>:</td><td align=left width="35%" colspan=2  class=tablelight><%=request.getParameter("dateofallocation_hidden") %></td>
...
%>
<br>
<div class=warning_box>Roll No. generated for this Student.So yo cant Trash.
</div>
<br><%
}
%>
	...
	<a href="#" class="bt_red" studentallocationid="<%=request.getParameter("studentallocationid_hidden")%>"  statusval="Trash" status="T" onclick="statusChangeFun(this)"><span class="bt_red_lft"></span><strong>Trash</strong><span class="bt_red_r"></span></a>
	<br><%
	}
	%>
