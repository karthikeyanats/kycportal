...
<script type="text/javascript">
	...
	function loadStandard()
	{
		...
		document.ApplicantSearch.action="StudentAllocation.jsp?reg_sessionid="+document.ApplicantSearch.reg_sessionid.value+"&reg_boardid="+document.ApplicantSearch.reg_boardid.value;
	...
	function viewStudent()
	{
		...
		else
		{
			...
			document.ApplicantSearch.action="ViewApprvStudents.jsp";
			document.ApplicantSearch.submit();
		}
	
	}
	
	function viewAllcStudent()
	{
		document.ApplicantSearch.action="StudentsAllocated.jsp";
		document.ApplicantSearch.submit();
	}
...
<%@ include file="../include/header.jsp" %>
	...
	<table id="rounded-corner" border=0 width="100%">
    	<thead>
    		<tr>
            	<th scope="col" class="rounded-company" width="80%">Allocation</th>
		...
		%>
			<tr>
			<td colspan=2><table border=0 align=center id="rounded-corner1" width="100%">
			<tr>
			...
			<%
				...
				{
				out.print("<tr><td width='43%' valign=top class='tablebold'>Archival Details</td><td class=tablebold width='2%' valign=top>:</td><td valign=top class='tablelight' ><h2>You can't Allocate Student for an Archived Year</h2></td></tr>");	
				}
			%>			
			</table></td></tr>
			</table>
    			...
    			<a href="#" class="bt_blue" onclick="viewAllcStudent()"><span class="bt_blue_lft"></span><strong>View Allocated Students</strong><span class="bt_blue_r"></span></a>
				<%
					...
					{
				%>
    			<a href="#" class="bt_green" onclick="viewStudent()"><span class="bt_green_lft"></span><strong>View Students to Allocate</strong><span class="bt_green_r"></span></a>
				<% 
					}
				%> 
