...
function goBack()
{
	document.approvalForm.action="RegistrationIssue_Pre1.jsp";
...
function applicationView(obj)
{
	...
	document.approvalForm.action="RegistrationReportView.jsp";
	document.approvalForm.submit();
}
...
<%@ include file="../include/header.jsp" %>
    ...
    <h2>Enrollment / Student Enrollment / Admission Report</h2>
...
<table id="rounded-corner" border=0 summary="Department List" width="100%">
    <thead>
	 ...
	 com.iGrandee.Application.ApplicationQuery  applicationQuery = new com.iGrandee.Application.ApplicationQuery();	
	    ...
	    applicationCountList	=	(ArrayList)applicationQuery.getReport(request.getParameter("req_sessionid"),request.getParameter("req_boardid"),instituteid,"Registration");
...
if(request.getParameter("req_sessionstatus") != null && request.getParameter("req_sessionstatus").equals("R")){
	out.print("<tr><td class=tablebold width='25%'>"+bundle.getString("label.admisionreport.ArchivalDetails")+"</td><td class=tablebold width='2%'>:</td><td class=tablelight >"+bundle.getString("label.admisionreport.message")+"</td></tr>");
}
%>
</table>
</td></tr>
...
<br>
	...
	<a href="#" class="bt_green" onclick="datewiseReport()"><span class="bt_green_lft"></span><strong><%=bundle.getString("button.admisionreport.DatewiseReport")%></strong><span class="bt_green_r"></span></a>
	<%
		}
	%>
		</td>
