...
<title>Know Your Child - Students Allocated Select | Powered by i-Grandee</title>
...
<script type="text/javascript">
	...
	function viewStudent()
	{
		...
		else
		{
			...
			document.ApplicantSearch.action="StudentsAllocatedView.jsp";
			document.ApplicantSearch.submit();
		}
	...
	function goBack()
	{
		document.ApplicantSearch.action="StudentAllocation.jsp";
		document.ApplicantSearch.submit();
	}
...
<%@ include file="../include/header.jsp" %>
	...
	<table id="rounded-corner" border=0 width="100%">
    	<thead>
    		<tr>
            	<th scope="col" class="rounded-company" width="80%">Allocated View</th>
		...
		%>
			...
			%>	
    			...
    			<a href="#" class="bt_green" onclick="viewStudent()"><span class="bt_green_lft"></span><strong>View Students</strong><span class="bt_green_r"></span></a>
