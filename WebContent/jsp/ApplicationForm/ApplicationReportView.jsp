...
<title><%=bundle.getString("label.product.name")%> - Applicant List | Powered by i-Grandee</title>
...
function goBack()
{
	document.applicationForm.action= "ApplicationReport.jsp";
...
<%@ include file="../include/header.jsp" %>
    ...
    <h2><%=bundle.getString("label.applicationreportview.rootpath")%></h2>
...
<table id="rounded-corner" border=0 width="100%">
	...
	<tr><td class=tablebold width="25%"><%=bundle.getString("label.applicationreport.Standard")%></td><td class=tablebold width='2%'>:</td><td class=tablelight colspan=4><%=request.getParameter("standardnamegp") %></td>
</tr>
	<% 
...
<table id="rounded-corner" border=0 width="100%" align="center">
   <thead>
    	<tr>
        	<th scope="col" class="rounded-company" width="8%"><%=bundle.getString("label.applicationreport.SL.No")%></th>
            <th scope="col" class="rounded" width="29%"><%=bundle.getString("label.applicationreport.ApplicantName")%></th>
            <th scope="col" class="rounded" width="13%"><%=bundle.getString("label.applicationreport.ApplicationNo")%></th>
            <th scope="col" class="rounded" width="10%"><%=bundle.getString("label.applicationreport.ReceiptNo")%></th>
            <th scope="col" class="rounded" width="20%"><%=bundle.getString("label.applicationreport.ApplicationFees")%></th>
            <th scope="col" class="rounded-q4" width="20%"><%=bundle.getString("label.applicationreport.DateofIssue")%></th>
