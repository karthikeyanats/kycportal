...
<h2><%=bundle.getString("label.staffcertificateupdate.rootpath")%></h2>
<%@ page
...
<input type="hidden" name="documentcreation" value="creation">  
			...
			<tbody>
				<tr>
					...
					<table border=0 bordercolor='#EFEFE7' align=center class=tablehead
						...
						<tr class=tablebold><td width="100%" align=left>
						<table width="100%" border=0 bgcolor="#ffffff" cellpadding=0
							cellspacing=0>
							<%
												out.println("<tr>");
												out.println("<td class='tablelight' width='20%' >"+bundle.getString("label.staffcertificateupdate.DocumentName")+"</td>");
												out.println("<td class='tablelight' width='80%' >");
												out.println("<input type=text name='certificatename' validate='Document Name' value='' size=35/></tr>");
												out.println("<tr><td class='tablelight' width='20%' > "+bundle.getString("label.staffcertificateupdate.DocumentFile")+"Document File ");
