...
function backfun()
{
if(document.f1.backward.value=="adminhome")
{
document.f1.action= "<%=request.getContextPath()%>/jsp/kycpanel/Homepage.jsp";
}
else if (document.f1.backward.value=="facultyhome")
{
document.f1.action= "<%=request.getContextPath()%>/jsp/Staff/StaffHomepage.jsp";
}
else
{
...
function experienceprofileupdate()
{
document.f1.action= "./StaffExperienceprofileupdate.jsp";
document.f1.submit();
}
function personalprofileupdate()
{
document.f1.action= "./Staffpersonalprofileupdate.jsp";
document.f1.submit();
}



function verificationcertificateupdate()
{
document.f1.action= "./Staffverificationcertificateupdate.jsp";
document.f1.submit();
}
function win(obj)
{
...
function addfun()
{
	document.f1.action="./StaffCertificateAdd.jsp";   
	document.f1.submit();
}
</script>
...
<%@ include file="../include/header.jsp" %>
    ...
    <h2><%=bundle.getString("label.staffprofile.rootpath") %></h2>
	...
	if(p_list!=null && p_list.size()>0)
	{
		...
		if(m_status==null)
		 ...
		 staffuserid=(String)map.get("userid");
			//System.out.println("================photo====>"+photo);
		 staffusername=(String)map.get("username");
		 staffstatus=(String)map.get("staffstatus");
		}
...
<input type =hidden name='hiddenuser_id' value="<%=staffusername %>" />
<input type="hidden" name="personid" value="<%=staffuserid%>">
  ...
  <TR valign="top" style="height:190">
      <TD>
    	...
    	<tr>
            ...
            <th scope="col" class="rounded-q4" width="1%"><a href="#"
						onclick="personalprofileupdate()" id="edit1" ><img align=right
						src="<%=request.getContextPath()%>/jsp/kycpanel/images/user_edit.png"
						alt="" title="Update" border="0" /></a></th>
...
<table id="rounded-corner" border=0 summary="Department List"
			...
			<thead>
				<tr>
					...
					<th scope="col" class="rounded-q4" width="1%"><a href="#"
						onclick="contactprofileupdate()" id="edit2" ><img align=right
						src="<%=request.getContextPath()%>/jsp/kycpanel/images/user_edit.png"
						alt="" title="Update" border="0" /></a></th>
				...
				<table border=0 bordercolor='#EFEFE7' align=center class=tablehead
					...
					<tr>
						...
						<table width="100%" border=0 bgcolor="#ffffff" cellpadding=0
							...
							<tr>
							<td  colspan=2>
							<table border=0 bordercolor='#EFEFE7' align=center class=tablehead	cellpadding=0 cellspacing=0 width="100%" >
							<tr height=25>
								<td align=left>
	<table border=0 bordercolor='#EFEFE7' align=center class=tablehead
					cellpadding=0 cellspacing=0 width="95%" rules="groups">							<tr height=25>
							...
							<tr style="height: 25">
								<td class="tablebold" style="width: 15%"><%=bundle.getString("label.staffprofile.Email") %>
								</td>
								<td class="tablelight" style="width: 35%" colspan=3><a href="mailto:<%=email%>"><%=email%></a>  
								</td>
		...
		<table id="rounded-corner" border=0 summary="Department List"
			...
			<thead>
				<tr>
					...
					<th scope="col" class="rounded-q4" width="1%"><a href="#"
						onclick="verificationcertificateupdate()" id="edit3" ><img align=right
						src="<%=request.getContextPath()%>/jsp/kycpanel/images/user_edit.png"
						alt="" title="Update" border="0" /></a></th>
				...
				<tr>
					...
					<table border=0 bordercolor='#EFEFE7' align=center class=tablehead
						...
						<table width="100%" border=0 bgcolor="#ffffff" cellpadding=0
							...
							<tr>
							<td >
							<a href="#" onclick="addfun()" class=tablebold >Add New Verification Certificate</a>
						</table>
						</td>
						</tr>
					</table>
...
<table id="rounded-corner" border=0 summary="Department List" width="100%">
    	...
    	<tr>
            ...
            <th scope="col" class="rounded-q4" width="1%"><a href="#"
						onclick="experienceprofileupdate()" id="edit5" ><img align=right
						src="<%=request.getContextPath()%>/jsp/kycpanel/images/user_edit.png"
						alt="" title="Update" border="0" /></th>
						...
						<td width="100%">
								<table width="100%" border=0 bgcolor="#ffffff" cellpadding=0 cellspacing=0>
									...
									<td class="tablebold" style="width:15%">
										...
										<td class="tablebold" style="width:35%">
											<%= bundle.getString("label.staffdetails.%OfMarks")%>
										</td>
									</tr>
				...
				<table border=0 bordercolor='#EFEFE7' align=center class=tablehead cellpadding=0 cellspacing=0 width="95%" rules="groups">
						...
						<td width="100%">
								<table width="100%" border=0 bgcolor="#ffffff" cellpadding=0 cellspacing=0 >
									<tr style="height:25">
									<td class="tablebold" style="width:15%">
											 <%= bundle.getString("label.staffdetails.SL.No")%>
										</td>
										<td class="tablebold" style="width:40%">
											 <%= bundle.getString("label.staffdetails.Position")%>
										</td>
										<td class="tablebold" style="width:45%">
											<%= bundle.getString("label.staffdetails.Period")%>
										</td>
									</tr>
									<%
									//out.println("q_list.size()"+q_list.size());
						...
						<td width="100%">
								...
								{%>
									...
									{ %>
										...
										<%= bundle.getString("label.staffdetails.Publication")%>
										</td>
...
<%} %>
			 ...
			 <a href="#bbsb" name="bbsb" onclick=backfun() class="bt_blue" align=center><span class="bt_blue_lft"></span><strong><%= bundle.getString("button.staffdetails.Back")%></strong><span class="bt_blue_r"></span></a>
			
<%} %>

<script>
	if(document.f1.staffstatus.value=="D")
	{
		document.getElementById("edit1").style.visibility="hidden";
		document.getElementById("edit2").style.visibility="hidden";
		if(document.getElementById("edit3")!=null)
		document.getElementById("edit3").style.visibility="hidden";
		if(document.getElementById("edit4")!=null)
