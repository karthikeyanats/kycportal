...
<title>Know Your Child -<%=bundle.getString("label.staffpromotion.title") %>| Powered by i-Grandee</title>
...
<%@ include file="../include/header.jsp" %>
    ...
    <h2><%=bundle.getString("label.staffpromotion.rootpath") %></h2>
...
<table id="rounded-corner" border=0 summary="Department List" width="100%">
    <thead>
    	<tr>
        	<th scope="col" class="rounded-company" width="10%"><%=bundle.getString("label.staffpromotion.SL.No") %></th>
            <th scope="col" class="rounded" width="65%"><%=bundle.getString("label.staffpromotion.DepartmentName") %></th>
            <th scope="col" class="rounded-q4" width="25%"><%=bundle.getString("label.staffpromotion.NoOfStaff's") %></th>
        </tr>
    </thead>
    <tfoot>
    	<tr>
		...
		try
		{
	 		...
	 		for(int i=0;i<deptList.size();i++) {
	    		...
	    		String deptname = (String)deptMap.get("departmentname");
	 		   	...
	 		   	out.println("<td><a href='#' depid='"+deptid+"' onclick='viewdepartment(this)' >"+deptname+"</a></td>");
