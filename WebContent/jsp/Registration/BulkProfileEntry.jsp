...
<script language="JavaScript">
	...
	function submitfun(){
		...
		if(check_ForParticularElements(document.MainForm.session,"select",document.MainForm.board,"select",document.MainForm.standard,"select",document.MainForm.profilefile,"text")){
			...
			if(ext == "xls"){
				...
				document.MainForm.action= "./BulkProfileView.jsp";
		    	...
		    	<td colspan=2>
		     		<table  border=0 summary="Department List" width="100%">
						...
						<tr>
							...
							<td class=tablebold>:</td>
							<td>
								<select name='standard' validate='Standard'>
	...
	<table id="rounded-corner" border=0 summary="Department List" width="100%">
	    <thead>
	    	<tr>
	        	...
	        	<th scope="col" class="rounded-q4" width="25%" class='tablebold'><a href='./SampleTemplate.xls' target='_new'>Download Sample Template</a></th>
