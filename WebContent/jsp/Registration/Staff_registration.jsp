...
if(check_ForParticularElements(document.f1.user_first_name,"text",document.f1.user_last_name,"text",document.f1.user_final_qualification,"text",document.f1.user_bday,"text",document.f1.user_age,"text",document.f1.user_fathername,"text",document.f1.user_mothername,"text",document.f1.user_street1,"text",document.f1.user_street2,"text",document.f1.country,"select",document.f1.user_state,"select",document.f1.user_city,"text",document.f1.user_zipcode,"text",document.f1.permanentuser_street1,"text",document.f1.permanentuser_street2,"text",document.f1.permanentcountry,"select",document.f1.permanentuser_state,"select",document.f1.permanentuser_city,"text",document.f1.permanentuser_zipcode,"text",document.f1.user_phone,"text",document.f1.smscontactno,"text",document.f1.user_private_mail_id,"text",document.f1.user_department,"select",document.f1.user_role,"select",document.f1.user_joining_date,"text",document.f1.user_id,"text",document.f1.user_passwd1,"text",document.f1.user_passwd2,"text"))	
{
...
<tr height=30>
<td class=tablebold><font color="red">*</font>&nbsp;<%=bundle1.getString("label.staffregisteration.FirstName") %>&nbsp;</td>
...
<td class=tablelight><input readonly type = text name="user_bday" class=tablelight value="" maxlength=50 size=20 validate="Date of Birth" onkeydown='this.blur();calcagefun();' onchange="calcagefun()" ><input type="button" class="tablehead" value="^" onclick="document.f1.user_bday.value='';Calendar_Fun('<%=request.getContextPath()%>/js/Calendar/CalendarWindow.html','f1.user_bday','1000',event,'Not_Greater_Than_CurrentDate',document.f1.server_date);" />          
</td>
</tr>
<tr height=30>   
...
<tr align="left">
					<td colspan=2>
					<input type="radio" name="phototype" validate="Photo" value='local' onclick="loadphototype('local')" checked/><%=bundle1.getString("label.studentprofileentry.UploadImage")%><input type="radio" name="phototype" validate="Photo" value='snapshot' onclick="loadphototype('webcam')"/><%=bundle1.getString("label.studentprofileentry.CaptureImage")%>
					</td>
					</tr>
					<tr align="left">
					<td colspan=2>
					<table border='0' bordercolor='yellow' id="localphoto" style="display:block;" >  
						...
						<td align="left" valign="bottom" width="65%"><input size='30' validate="Photo" type=file class="browses" name="user_photo"	/></td>
					</tr>
					</table>
					</td>
					</tr>  
...
<td><input type=text name = "user_street1" maxlength=50 size=35  validate="Communication Street1" value="" class=tablelight /></td>
</tr>

<tr height=30>
<td class=tablebold><font color="red">*</font>&nbsp;<%=bundle1.getString("label.staffregisteration.Street2") %>&nbsp;</td>
<td><input type=text name = "user_street2" validate="Communication Street2" maxlength=50 size=35 value="" class=tablelight /></td>
</tr>
<tr height=30>
...
<td><select size=1 cols=20 id=country name="country" validate="Communication Country" style="width:250px" class=tablelight onchange="country_fun(document.getElementById('user_state'),this,document.getElementById('user_state1'));">
...
<td>
<select id = "user_state"  name = "user_state" validate="Communication State" style="width:250px" class=tablelight><option>Select State</option></select>
...
<td><input type = text name = "user_city" validate="Communication City" maxlength=50 size=15 value="" class=tablelight /></td>
</tr>


<tr height=30>
<td class=tablebold><font color="red">*</font>&nbsp;<%=bundle1.getString("label.staffregisteration.PostalCode") %>&nbsp;</td>
<td><input type = text name = "user_zipcode" maxlength=6 size=15 validate="Communication Postal Code" value="" onkeypress="checkNumber(event)" class=tablelight /></td>
</tr>
<tr height=30  class=tableheading>
...
<tr height=30>  
<td class=tablebold><font color="red">*</font>&nbsp;<%=bundle1.getString("label.staffregisteration.Street1") %>&nbsp;</td>
<td><input type=text name = "permanentuser_street1" maxlength=50 size=35  validate="Permanent Street1" value="" class=tablelight /></td>
</tr>

<tr height=30>
<td class=tablebold><font color="red">*</font>&nbsp;<%=bundle1.getString("label.staffregisteration.Street2")%>&nbsp;</td>
<td><input type=text name = "permanentuser_street2" maxlength=50  validate="Permanent Street2" size=35 value="" class=tablelight /></td>
</tr>
...
<td class=tablebold><font color="red">*</font>&nbsp;<%=bundle1.getString("label.staffregisteration.Country") %>&nbsp;</td>
<!--<td><input type=text size=12 name='country' validate="Country" class=tablelight value="" value=""></td>-->
<td><select size=1 cols=20 name="permanentcountry" validate="Permanent Country" style="width:250px" class=tablelight onchange='country_fun(document.f1.permanentuser_state,this,document.f1.permanentuser_state1);'>
...
<td class=tablebold><font color="red">*</font>&nbsp;<%=bundle1.getString("label.staffregisteration.State") %>&nbsp;</td>
<td>
<select name = "permanentuser_state" validate="Permanent State" style="width:250px" class=tablelight><option>Select State</option></select>
<input type="text" name='permanentuser_state1' maxlength=50 />
</td>
</tr>
<tr height=30>
<td class=tablebold><font color="red">*</font>&nbsp;<%=bundle1.getString("label.staffregisteration.City") %>&nbsp;</td>
<td><input type = text name = "permanentuser_city" validate="Permanent City" maxlength=50 size=15 value="" class=tablelight /></td>
</tr>


<tr height=30>
<td class=tablebold><font color="red">*</font>&nbsp;<%=bundle1.getString("label.staffregisteration.PostalCode") %>&nbsp;</td>
<td><input type = text name = "permanentuser_zipcode" maxlength=6 size=15 validate="Permanent Postal Code" value="" onkeypress="checkNumber(event)" class=tablelight /></td>
</tr>
	<tr height=30>
	<td class=tablebold><font color="red">*</font>&nbsp;<%=bundle1.getString("label.staffregisteration.MobileNo") %><br></td>
	<td><span id=phone></span><input type = text name="user_phone" validate='Mobile Number' size=35 value="" onkeypress="checkNumber(event)" maxlength=25 class=tablelight value="" /></td>
	</tr>
	<tr>
...
<td valign="top" height="60"><input type=text name="user_private_mail_id" size=35 validate="Email" value="" class=tablelight maxlength=40 /></td>
</tr>
<tr  class=tableheading height="30">
	...
	<tr><td colspan=6>
		...
		<tr bgcolor='#AED7FF' class=tablehead align=center>
			<td><%=bundle1.getString("label.staffregisteration.Major") %></td>
   ...
   <tr  class=tableheading  height="30">
		<td colspan=3> <%=bundle1.getString("label.staffregisteration.Certificate") %> </td><td align=right>(<font color=red> <%= bundle1.getString("button.staffregisteration.optional")%></font> )</td>  
		</tr>
	...
	<td valign="top" height="40"><select name="user_role" class=tablelight validate="Position" style="width:250px">
