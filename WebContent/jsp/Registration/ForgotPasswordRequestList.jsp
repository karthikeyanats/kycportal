...
<title>Know Your Child - <%=bundle.getString("label.forgotpasswordlist.title") %>| Powered by i-Grandee</title>
...
<%@ include file="../include/header.jsp" %>
    ...
    <h2><%=bundle.getString("label.forgotpasswordlist.rootpath") %> </h2>
...
<%
	...
	try
	{
			...
			forgotList =staffquery.listForgotPasswordRequest(instituid,"others");
	}
	catch(NullPointerException e){}
%>
<form name="f1" method="post" action="" >
<table border=0 cellpadding=0 cellspacing=0 width="100%">
<tr><td align=right><a href="parentforgotpasswordlist.jsp" class=tablebold><%=bundle.getString("label.schedule.parentpasswordrequestlist")%></td></tr>
</table>
