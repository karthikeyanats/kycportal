...
<%@ include file="../include/header.jsp" %>
    ...
    <h2><%=bundle.getString("label.stafflistview.D_viewrootpath") %> / <%=request.getParameter("deptname")%> </h2>
...
<%
	...
	try
	{
			...
			deptList =staffquery.departmentWiseDeactiveStaff(departid);
	}
			...
			if(deptList.size()!=0)
			{
	 		...
	 		for(int i=0;i<deptList.size();i++) {
		    	...
		    	String categoryname = (String)deptMap.get("categoryname")+"";
	 		   	...
	 		   	out.println("<td><a href='#' onclick='updatestaffstatus(this)' roleid='"+roleid+"' Staffid='"+Staffid+"' Staffname='"+Staffname+"' status='A'>"+bundle.getString("hlink.stafflistview.Active")+"</a></td>");
	 		   	out.println("</tr>");
