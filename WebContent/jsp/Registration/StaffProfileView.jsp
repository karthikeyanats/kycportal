...
else if (document.f1.backward.value=="principalhome")
{
document.f1.action= "<%=request.getContextPath()%>/jsp/Principal/PrincipalHomepage.jsp";
}
else if (document.f1.backward.value=="libraryhome")
{
document.f1.action= "<%=request.getContextPath()%>/jsp/Library/LibraryHome.jsp";
}
