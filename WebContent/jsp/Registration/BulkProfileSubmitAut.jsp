...
<script language='javascript'>
	...
	function LoadStatus()
	{
		...
		document.wkrkallotmentsubmit.action = "./../Opreation_result_withrequest.jsp";
...
<%@ page language="java" import="com.iGrandee.Registration.StudentRegistrationBean,com.iGrandee.Registration.StudentRegistrationQuery"%>
	...
	<%
		...
		try {
	    	...
	    	bean.setGuardianmails(request.getParameterValues("guardianmail"));
	    	...
	    	bean.setSessionid(request.getParameter("sessionid"));
	    	bean.setBoardid(request.getParameter("boardid"));
	    	bean.setCommunities(request.getParameterValues("community"));
	    	bean.setReligions(request.getParameterValues("community"));
	    	bean.setRegistionno(request.getParameterValues("studentrollno"));
	    	bean.setScholarshipamountallocationid(request.getParameterValues("scholarshipname"));
	    	bean.setFeestermid(request.getParameter("termfeesid"));
	    	
	    	
	    	
			result					= qentry.bulkStudentRegistrationAuto(bean);
	...
	<input type='text'   name='returnurl' 		value='./Registration/BulkProfileEntryAut.jsp'>
