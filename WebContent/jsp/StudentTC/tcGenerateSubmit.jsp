...
try
{
	...
	//System.out.println("studentallocationId-->"+studentallocationId+"createdby-->"+createdby);
		tcGenerationBean.setStudentallocationid(studentallocationId);
		...
		rows += tcGenerationQuery.insertTCGeneration(tcGenerationBean);
		
		if(rows>0)
			op 	= 	"TC Issued Successfully";
		else
			op	=	"TC Issue Failed";
		
		return_file = request.getContextPath()+"/jsp/StudentTC/TCGenerateView.jsp";
