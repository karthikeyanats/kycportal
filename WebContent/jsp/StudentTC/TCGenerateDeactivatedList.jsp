...
<title>Know Your Child - TC Issued Deactivated View | Powered by i-Grandee</title>
...
<%@ include file="../include/header.jsp" %>
    ...
    <h2>Certificate / Transfer Certificate Deactivated View</h2>
...
<table id="rounded-corner" border=0 summary="Department List" width="100%">
    <thead>
	 ...
	 <%
		...
		registeredList	=	(ArrayList)tcgenerationQuery.listTCIssuedDetails(request.getParameter("req_sectionpubid"),"D");
       %>
		...
		<table id="rounded-corner" border=0 summary="Department List" width="100%">
		    <thead>
		    	<tr>
		            ...
		            <th scope="col" class="rounded-q4" width="5%">Action</th>
			...
			<%
				...
				if(registeredList.size()!=0)
				{
					for(int i=0;i<registeredList.size();i++)
					{
						...
						%>
						<td><a href="#"   applicantname="<%=applicantName %>" applicationno="<%=applicationNo %>" tcissueid="<%=tcissueId%>" statusval="Activate" status="A" onclick="statusChangeFun(this)" class="ask">Activate</a></td>
			            <% 
					}
				}
				else
