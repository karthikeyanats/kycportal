...
<title>Know Your Child - <%=bundle.getString("label.flashnews.deactivatelisttitle") %> | Powered by i-Grandee</title>
...
String instituteid=(String)session.getValue("instituteid");
	...
	try {
		...
		no_of_rows = query_object.listDeactFlash(instituteid);
...
<%@ include file="../include/header.jsp" %>
    ...
    <h2><%=bundle.getString("label.flashnews.deactivatelistrootpath") %></h2>
...
<table id="rounded-corner" border=0 summary="Department List" width="100%">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded" width="65%"> <%=bundle.getString("label.flashnews.contentname") %>e</th>
            <th scope="col" class="rounded" width="20%"><%=bundle.getString("label.flashnews.dateofcreation") %></th>
            <th scope="col" class="rounded-q4" width="10%" ><%=bundle.getString("label.flashnews.active") %></th>
          </tr>
    </thead>
    <tfoot>
    	<tr>
		  	...
		  	String[] count=null;
				if(no_of_rows != null && no_of_rows.size()>0)
				{
					...
					{		out.println("<tr>");
						...
						out.println("<td class='tablelight'><a href='#' onclick=actionfun('Activate',this) contentid='"+hm.get("flashid")+"' content='"+hm.get("flashmessage")+"' >Activate</td>");
				...
				else
				{
					...
					//out.println("<td align=center colspan=4>Data Not Found</td>");
				}
		  	%>
		  	</table>
		  	</td></tr></table>
