...
<%
		...
		//{
			   ...
			   rootlabel= staffquery.fieldValue("institutename","institution","instituteid",instituteid,"status",instituteid)+" / "+bundle.getString("label.superadmin.studentlistrootpath")+" / "+bundle.getString("label.superadmin.sectionlistrootpath");			   
...
<form name="Student_Form" action="" method="post">
						...
						<input type="hidden" name="condition" value="superadminsecview">
