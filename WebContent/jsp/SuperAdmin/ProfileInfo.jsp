...
<br>
<h2><%=bundle.getString("label.superadmin.inforootpath") %></h2>
 ...
 %>
  <jsp:useBean id="instituteQuery" scope="page"
	class="com.iGrandee.Registration.InstitutionQurey" /> <%
 	...
 	instituteArray = instituteQuery.getInstituteDetails(instituteid);
...
<table border=0 id="rounded-corner" align="center" width="100%" cellspacing=0 cellpadding=0 rules="groups">
	<thead>
		<tr class=tableheading valign="top">
			<th width="90%" class="rounded-company"><%=bundle.getString("label.profileinfo.infotableheading") %></th>
			<th width="10%" class="rounded-q4" align="right"></th>
			<!--  ><th width="10%" class="rounded-q4" align="right"><a href="SchoolInformationUpdate.jsp" ><=bundle.getString("hlink.profileinfo.update") %></th>-->
		</tr>
		<tr>
		<td colspan="2">
			<table border='0' align="center" width="100%" > 
				...
				<tr style="height: 25">
					...
					<td class=tablebold>:</td>
					<td class="tablelight" colspan="1"><%=contactaddress%></td>
				</tr>
				<tr style="height: 25">
				...
				<tr style="height: 25">
					...
					<td class=tablebold>:</td>
					<td class="tablelight" width="20%"  colspan="1">
					<%
					if(url.equals("-"))
						out.print(url);
					else
