...
function backfun()
{
document.Student_Form.action="./StandardView.jsp";
document.Student_Form.submit();
}
...
document.Student_Form.action="<%=request.getContextPath()%>/jsp/Principal/StudentProfileView.jsp";
document.Student_Form.submit();
}
...
<%
		...
		//{
			   ...
			   rootlabel= staffquery.fieldValue("institutename","institution","instituteid",instituteid,"status",instituteid)+" / "+bundle.getString("label.superadmin.studentlistrootpath");			   
		...
		//}
		if(!standardscheduleid.equals("null")  && !sex.equals("null"))
		{
			StudentList=prinicipal.loadstudentforstandardscheduleidwithstatus(standardscheduleid,sex,status); 
		}
...
<form name="Student_Form" action="" method="post">
						...
						<input type="hidden" name="condition" value="superadminview">
		...
		int Totalstudent=0;
							if(StudentList != null && StudentList.size()>0)
								...
								for(int y=0,i=1;y<StudentList.size();y++,i++){
									...
									{
										out.print("<tr align=left class=tablebold ><td colspan=3>"+hashmap.get("sectionname")+""+"</td></tr>");
										tempsectionid=sectionid;
									}
									out.print("<tr align=left  ><td>"+i+"</td>");
									out.println("<td align=left><a href='#studenthref' name='studenthref'  studentallocationid='"+studentallocationid+"' personid='"+personid+"' onclick='loadStudentProfile(this)'>"+uname+"</a></td>");
									out.println("<td align=left>"+rollno+"</td>");
									out.println("</tr>");
								}
								}
							else
