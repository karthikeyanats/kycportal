...
<%
		...
		String rootlabel= staffquery.fieldValue("institutename","institution","instituteid",instituteid,"status",instituteid)+" / "+bundle.getString("label.superadmin.studentlistrootpath");
		String	status  = "A";
