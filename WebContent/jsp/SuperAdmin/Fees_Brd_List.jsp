...
document.f1.action= "./FeesView.jsp";
document.f1.submit();
}

function backfun()
{
document.f1.action= "./Fees_Year_List.jsp";
document.f1.submit();
}
</script>
...
%>
    <h2><%=staffquery.fieldValue("institutename","institution","instituteid",instituid,"status",instituid)%> / <%=bundle.getString("label.superadmin.feeslistrootpath") %></h2>
<form name="f1" method="post" action="" >
