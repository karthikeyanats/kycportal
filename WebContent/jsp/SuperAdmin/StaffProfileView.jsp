...
function backfun()
{
document.f1.action= "<%=request.getContextPath()%>/jsp/SuperAdmin/Staff_List_View.jsp";
document.f1.submit();
}
...
%>
    <h2><%=staffquery.fieldValue("institutename","institution","instituteid",request.getParameter("req_instituteid"),"status",request.getParameter("req_instituteid"))%> / <%=bundle.getString("label.superadmin.stafflistrootpath") %> / <%=request.getParameter("deptname")%> / Staff Profile</h2>
<%
	//personal
	String name="-";
	String fname="-";
