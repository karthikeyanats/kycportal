...
<title>i-Grandee Education - Bulk Question Entry | Powered by i-Grandee</title>
	...
	function submitFun(){
		...
		if(check_ForParticularElements(document.question_form.board,"select",document.question_form.standard,"select",document.question_form.subject,"select",document.question_form.lesson,"select",document.question_form.examtype,"select",document.question_form.questiontype,"select",document.question_form.difficultyfactor,"select",document.question_form.occurence,"select",document.question_form.startdate,"text",document.question_form.enddate,"text",document.question_form.questionfile,"text")){
			...
			if(ext =="xls" || ext=="XLS" || ext == "XLSX" || ext == "xlsx")
			{
				...
				document.question_form.action 				= "QuestionViewExcel.jsp";
				document.question_form.submit();
			}
			else
			{
				alert("Only .xls or .xlsx Documents are Allowed");
			}
		}
	}
	...
	function changeOccurence(){
		if(check_ForParticularElements(document.question_form.occurence,"select")){
			if(document.question_form.occurence.options.selectedIndex == 1)
				...
				document.getElementById("displayoccurence").innerHTML="<font color='green'>"+document.question_form.occurence.options[document.question_form.occurence.options.selectedIndex].text+" Time Occurence(s)</font>";
...
<%@ include file="../include/examheader.jsp" %>
    ...
    <form name="question_form" action="" method="post" enctype="multipart/form-data">
		    ...
		    <tr>
		    	<td colspan='2'>						
					<table width='100%' align='center' border='0' cellpadding='5'>
						...
						<tr>
							<td width='20%' class='tablebold'>Question File</td>
							<td width='1%' class='tablebold'>:</td>
							<td class='tablelight'>
								<input type="file" name='questionfile' validate='Question File' size='20'/>
							</td>
						</tr>
		...
		<a href="#" class="bt_blue" onclick='submitFun()'><span class="bt_blue_lft"></span><strong>Load Question</strong><span class="bt_blue_r"></span></a>
