...
<%@ page language="java" import="com.iGrandee.ExamManagement.QuestionEntry,com.iGrandee.ExamManagement.QuestionUpload,com.iGrandee.ExamManagement.QuestionEntryBean"%>
	...
	try {
			...
			bean.setQuestion(upload.getParameterValues("questions"));
			bean.setAnswer(upload.getParameterValues("answers"));
			bean.setCorrectanswer(upload.getParameterValues("correctanswer"));
			bean.setTotalanswer(upload.getParameterValues("countanswer"));
			bean.setMark(upload.getParameterValues("mark"));
			bean.setTime(upload.getParameterValues("timelimit"));
			bean.setFiles(upload.getParameterValues("filenames"));
	...
	if(result >0)
		status	= "Question(s) Uploaded Successfully.";
	else
		status	= "Question(s) Uploading Failed.";
	...
	<input type='text'   name='returnurl' 		value='./ExamManagement/QuestionEntryExcel.jsp'>
